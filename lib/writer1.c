 ...
 */
KTX_error_code
ktxTexture1_setImageFromStream(ktxTexture1* This, ktx_uint32_t level, ktx_uint32_t layer,
...
ktxTexture1_WriteToStream(ktxTexture1* This, ktxStream* dststr) {
    ...
    for (level = 0, levelOffset = 0; level < This->numLevels; ++level) {
        ...
        faceLodSize = (ktx_uint32_t)ktxTexture_doCalcFaceLodSize(ktxTexture(This), level,
