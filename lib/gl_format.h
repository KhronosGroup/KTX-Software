...
*/
        ...
        #define GL_LUMINANCE_ALPHA_INTEGER \
            0x8D9D  // deprecated, same as GL_LUMINANCE_ALPHA_INTEGER_EXT
    #endif
...
*/
        ...
        #define GL_UNSIGNED_SHORT_4_4_4_4_REV \
            0x8365  // same as GL_UNSIGNED_SHORT_4_4_4_4_REV_IMG and
        ...
        #define GL_UNSIGNED_INT_10F_11F_11F_REV \
            0x8C3B  // same as GL_UNSIGNED_INT_10F_11F_11F_REV_EXT
    #endif
        ...
        #define GL_FLOAT_32_UNSIGNED_INT_24_8_REV \
            0x8DAD  // same as GL_FLOAT_32_UNSIGNED_INT_24_8_REV_NV and
                    // GL_FLOAT_32_UNSIGNED_INT_24_8_REV_ARB
    #endif
...
//
        ...
        #define GL_R11F_G11F_B10F \
            0x8C3A  // same as GL_R11F_G11F_B10F_APPLE and GL_R11F_G11F_B10F_EXT
    #endif
...
//
        ...
        #define GL_DEPTH_COMPONENT32F_NV \
            0x8DAB  // note that this is different from GL_DEPTH_COMPONENT32F
    #endif
        ...
        #define GL_DEPTH24_STENCIL8 \
            0x88F0  // same as GL_DEPTH24_STENCIL8_EXT and GL_DEPTH24_STENCIL8_OES
    #endif
        ...
        #define GL_DEPTH32F_STENCIL8_NV \
            0x8DAC  // note that this is different from GL_DEPTH32F_STENCIL8
    #endif

static inline GLenum
glGetFormatFromInternalFormat(const GLenum internalFormat) {
    ...
    case GL_COMPRESSED_RGBA_S3TC_DXT5_EXT:
        return GL_RGBA;  // line through 3D space plus line through 1D space, 4x4 blocks, unsigned
                         // normalized
...
static inline GLenum
glGetTypeFromInternalFormat(const GLenum internalFormat) {
    switch (internalFormat) {
    //
    // 8 bits per component
    //
    ...
    case GL_COMPRESSED_RGBA_S3TC_DXT1_EXT:
        return GL_UNSIGNED_BYTE;  // line through 3D space plus 1-bit alpha, 4x4 blocks, unsigned
                                  // normalized
    case GL_COMPRESSED_RGBA_S3TC_DXT5_EXT:
        return GL_UNSIGNED_BYTE;  // line through 3D space plus line through 1D space, 4x4 blocks,
                                  // unsigned normalized
    case GL_COMPRESSED_RGBA_S3TC_DXT3_EXT:
...
glGetTypeSizeFromType(GLenum type) {
    switch (type) {
    case GL_BYTE:
...
static inline void
glGetFormatSize(const GLenum internalFormat, ktxFormatSize* pFormatSize) {
    ...
    case GL_COMPRESSED_RGBA_S3TC_DXT1_EXT:  // line through 3D space plus 1-bit alpha, 4x4 blocks,
                                            // unsigned normalized
    ...
    case GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT:  // line through 3D space plus 1-bit alpha, 4x4
        ...
        pFormatSize->blockDepth = 1;
        break;
    case GL_COMPRESSED_RGBA_S3TC_DXT5_EXT:  // line through 3D space plus line through 1D space, 4x4
    ...
    case GL_COMPRESSED_LUMINANCE_ALPHA_LATC2_EXT:         // two lines through 1D space, 4x4 blocks,
                                                          // unsigned normalized
    case GL_COMPRESSED_SIGNED_LUMINANCE_ALPHA_LATC2_EXT:  // two lines through 1D space, 4x4 blocks,
                                                          // signed normalized
        pFormatSize->flags = KTX_FORMAT_SIZE_COMPRESSED_BIT;
        pFormatSize->paletteSizeInBits = 0;
        pFormatSize->blockSizeInBits = 128;
