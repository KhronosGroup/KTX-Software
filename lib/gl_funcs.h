 ...
 *
 * Dynamically retrieving pointers avoids apps or shared library builds having to link with OpenGL
 * {,ES} and avoids the need for compiling different versions of the libary for different OpenGL
 * {,ES} versions.
 */
