...
typedef enum { KTX_FORMAT_VERSION_ONE = 1, KTX_FORMAT_VERSION_TWO = 2 } ktxFormatVersionEnum;

typedef ktx_size_t (*PFNCALCDATASIZELEVELS)(ktxTexture* This, ktx_uint32_t levels);
...
#define ktxTexture_calcDataSizeLevels(This, levels) This->_protected->_vtbl.calcDataSizeLevels(This, levels);
#define ktxTexture_calcFaceLodSize(This, level) This->_protected->_vtbl.calcFaceLodSize(This, level);
#define ktxTexture_calcLevelOffset(This, level) This->_protected->_vtbl.calcLevelOffset(This, level);
...
KTX_error_code ktxTexture_iterateLoadedImages(ktxTexture* This, PFNKTXITERCB iterCb, void* userdata);
KTX_error_code ktxTexture_iterateSourceImages(ktxTexture* This, PFNKTXITERCB iterCb, void* userdata);

ktx_size_t ktxTexture_calcDataSizeTexture(ktxTexture* This);
ktx_size_t ktxTexture_calcImageSize(ktxTexture* This, ktx_uint32_t level, ktxFormatVersionEnum fv);
ktx_bool_t ktxTexture_isActiveStream(ktxTexture* This);
ktx_size_t ktxTexture_calcLevelSize(ktxTexture* This, ktx_uint32_t level, ktxFormatVersionEnum fv);
...
void ktxTexture_rowInfo(ktxTexture* This, ktx_uint32_t level, ktx_uint32_t* numRows, ktx_uint32_t* rowBytes,
                        ktx_uint32_t* rowPadding);
KTX_error_code ktxTexture_construct(ktxTexture* This, ktxTextureCreateInfo* createInfo, ktxFormatSize* formatSize);

KTX_error_code ktxTexture_constructFromStream(ktxTexture* This, ktxStream* pStream, ktxTextureCreateFlags createFlags);
