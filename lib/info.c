...
void printIdentifier(const ktx_uint8_t identifier[12]) {
 ...
 * @param [in]  stream  pointer to the ktxStream reading the file.
 */
void printKTXInfo(ktxStream *stream) {
	KTX_header header;
 ...
 */
void printBasisSGDInfo(ktx_uint8_t *bgd, ktx_uint64_t byteLength,
 ...
 * @param [in]     pHeader pointer to the header to print.
 */
void printKTX2Info2(ktxStream *stream, KTX_header2 *pHeader) {
 ...
 * @param [in]     stream     pointer to the ktxStream reading the file.
 */
void printKTX2Info(ktxStream *stream) {
	KTX_header2 header;
