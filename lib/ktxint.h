...
KTX_error_code _ktxUnpackETC(const GLubyte* srcETC, const GLenum srcFormat,
                             ...
                             GLubyte** dstImage, GLenum* format, GLenum* internalFormat,
 ...
 */
KTX_error_code ktxCompressZLIBInt(unsigned char* pDest, ktx_size_t* pDestLength,
                                  const unsigned char* pSrc, ktx_size_t srcLength,
                                  ktx_uint32_t level);
 ...
 */
KTX_error_code ktxUncompressZLIBInt(unsigned char* pDest, ktx_size_t* pDestLength,
                                    const unsigned char* pSrc, ktx_size_t srcLength);
