...
# For windows include the html pages as part of the 'tools' component to be accessible by 'ktx help'.
# On other systems 'ktx help' uses the man pages, so these can stay in the 'dev' component.
if(WIN32)
    set(KTX_INSTALL_HTML_COMPONENT tools)
else()
    set(KTX_INSTALL_HTML_COMPONENT dev)
endif()

install(
    DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/docs/html
    DESTINATION "${CMAKE_INSTALL_DOCDIR}"
    COMPONENT ${KTX_INSTALL_HTML_COMPONENT}
)

install(
    DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/docs/man/man1
