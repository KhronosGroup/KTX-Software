...
libktx_gyp_libktx_doc_target_buildDoc.intermediate: $(srcdir)/ktxDoxy $(srcdir)/LICENSE.md $(srcdir)/include/ktx.h $(srcdir)/lib/checkheader.c $(srcdir)/lib/errstr.c $(srcdir)/lib/etcdec.cxx $(srcdir)/lib/etcunpack.cxx $(srcdir)/lib/gl_format.h $(srcdir)/lib/gl_funcptrs.h $(srcdir)/lib/gles1_funcptrs.h $(srcdir)/lib/gles2_funcptrs.h $(srcdir)/lib/gles3_funcptrs.h $(srcdir)/lib/glloader.c $(srcdir)/lib/hashtable.c $(srcdir)/lib/ktxcontext.c $(srcdir)/lib/ktxcontext.h $(srcdir)/lib/ktxfilestream.c $(srcdir)/lib/ktxfilestream.h $(srcdir)/lib/ktxint.h $(srcdir)/lib/ktxmemstream.c $(srcdir)/lib/ktxmemstream.h $(srcdir)/lib/ktxstream.h $(srcdir)/lib/reader.c $(srcdir)/lib/swap.c $(srcdir)/lib/uthash.h $(srcdir)/lib/writer.c FORCE_DO_CMD
	$(call do_cmd,touch)
