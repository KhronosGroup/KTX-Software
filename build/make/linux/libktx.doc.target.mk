...
cmd_libktx_gyp_libktx_doc_target_buildDoc = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p build/docs/libktx; ./runDoxygen -o build/docs/libktx -t build/docs/libktx/.gentimestamp libktx.doxy

build/docs/libktx/html: obj := $(abs_obj)
build/docs/libktx/html: builddir := $(abs_builddir)
build/docs/libktx/html: TOOLSET := $(TOOLSET)
build/docs/libktx/html build/docs/libktx/man: libktx_gyp_libktx_doc_target_buildDoc.intermediate
	@:
...
all_deps += build/docs/libktx/html build/docs/libktx/man
action_libktx_gyp_libktx_doc_target_buildDoc_outputs := build/docs/libktx/html build/docs/libktx/man
