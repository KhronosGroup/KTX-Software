...
$(builddir)/testimages/Iron_Bars_001_normal.ktx2: TOOLSET := $(TOOLSET)
$(builddir)/testimages/Iron_Bars_001_normal.ktx2: $(srcdir)/tests/testimages/Iron_Bars_001_normal.ktx2 FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/testimages/Iron_Bars_001_normal.ktx2
...
$(builddir)/testimages/ktx_document_uastc_rdo_zstd.ktx2: TOOLSET := $(TOOLSET)
$(builddir)/testimages/ktx_document_uastc_rdo_zstd.ktx2: $(srcdir)/tests/testimages/ktx_document_uastc_rdo_zstd.ktx2 FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/testimages/ktx_document_uastc_rdo_zstd.ktx2
...
ktxtests_gyp_testimages_target_copies = $(builddir)/testimages/conftestimage_R11_EAC.ktx $(builddir)/testimages/conftestimage_RG11_EAC.ktx $(builddir)/testimages/conftestimage_SIGNED_R11_EAC.ktx $(builddir)/testimages/conftestimage_SIGNED_RG11_EAC.ktx $(builddir)/testimages/cubemap_yokohama_astc_8x8_srgb.ktx $(builddir)/testimages/cubemap_yokohama_bc2_srgb.ktx $(builddir)/testimages/cubemap_yokohama_etc2_srgb.ktx $(builddir)/testimages/etc1.ktx $(builddir)/testimages/etc2-rgba1.ktx $(builddir)/testimages/etc2-rgba8.ktx $(builddir)/testimages/etc2-rgb.ktx $(builddir)/testimages/etc2-sRGBa1.ktx $(builddir)/testimages/etc2-sRGBa8.ktx $(builddir)/testimages/etc2-sRGB.ktx $(builddir)/testimages/hi_mark.ktx $(builddir)/testimages/hi_mark_sq.ktx $(builddir)/testimages/luminance-reference-metadata.ktx $(builddir)/testimages/metalplate-amg-rgba8.ktx $(builddir)/testimages/no-npot.ktx $(builddir)/testimages/not4_rgb888_srgb.ktx $(builddir)/testimages/orient-down-metadata.ktx $(builddir)/testimages/orient-up.ktx $(builddir)/testimages/orient-up-metadata.ktx $(builddir)/testimages/pattern_02_bc2.ktx $(builddir)/testimages/rgb-amg-reference.ktx $(builddir)/testimages/rgba-reference.ktx $(builddir)/testimages/rgb-mipmap-reference.ktx $(builddir)/testimages/rgb-reference.ktx $(builddir)/testimages/rgb-reference-metadata.ktx $(builddir)/testimages/texturearray_astc_8x8_unorm.ktx $(builddir)/testimages/texturearray_bc3_unorm.ktx $(builddir)/testimages/texturearray_etc2_unorm.ktx $(builddir)/testimages/alpha_simple_basis.ktx2 $(builddir)/testimages/cimg5293_uastc.ktx2 $(builddir)/testimages/cimg5293_uastc_zstd.ktx2 $(builddir)/testimages/color_grid_basis.ktx2 $(builddir)/testimages/color_grid_uastc.ktx2 $(builddir)/testimages/color_grid_uastc_zstd.ktx2 $(builddir)/testimages/color_grid_zstd.ktx2 $(builddir)/testimages/cubemap_goldengate_uastc_rdo4_zstd5_rd.ktx2 $(builddir)/testimages/cubemap_yokohama_basis_rd.ktx2 $(builddir)/testimages/FlightHelmet_baseColor_basis.ktx2 $(builddir)/testimages/Iron_Bars_001_normal.ktx2 $(builddir)/testimages/kodim17_basis.ktx2 $(builddir)/testimages/ktx_app_basis.ktx2 $(builddir)/testimages/ktx_app-u.ktx2 $(builddir)/testimages/ktx_document_basis.ktx2 $(builddir)/testimages/ktx_document_uastc_rdo_zstd.ktx2 $(builddir)/testimages/orient-down-metadata-u.ktx2 $(builddir)/testimages/orient-up-metadata.ktx2 $(builddir)/testimages/orient-up-metadata-u.ktx2 $(builddir)/testimages/pattern_02_bc2.ktx2 $(builddir)/testimages/rgba-mipmap-reference-basis.ktx2 $(builddir)/testimages/rgba-reference-u.ktx2 $(builddir)/testimages/rgb-mipmap-reference-u.ktx2 $(builddir)/testimages/texturearray_astc_8x8_unorm.ktx2 $(builddir)/testimages/texturearray_bc3_unorm.ktx2 $(builddir)/testimages/texturearray_etc2_unorm.ktx2
