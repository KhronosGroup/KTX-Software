...
$(SHARED_INTERMEDIATE_DIR)/cube.frag.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=fragment" -o "$(SHARED_INTERMEDIATE_DIR)/cube.frag.spv" "tests/loadtests/vkloadtests/shaders/cube/cube.frag"
...
$(SHARED_INTERMEDIATE_DIR)/reflect.frag.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=fragment" -o "$(SHARED_INTERMEDIATE_DIR)/reflect.frag.spv" "tests/loadtests/vkloadtests/shaders/cubemap/reflect.frag"
...
$(SHARED_INTERMEDIATE_DIR)/skybox.frag.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=fragment" -o "$(SHARED_INTERMEDIATE_DIR)/skybox.frag.spv" "tests/loadtests/vkloadtests/shaders/cubemap/skybox.frag"
...
$(SHARED_INTERMEDIATE_DIR)/texture.frag.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=fragment" -o "$(SHARED_INTERMEDIATE_DIR)/texture.frag.spv" "tests/loadtests/vkloadtests/shaders/texture/texture.frag"
