...
$(SHARED_INTERMEDIATE_DIR)/cube.vert.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=vertex" -o "$(SHARED_INTERMEDIATE_DIR)/cube.vert.spv" "tests/loadtests/vkloadtests/shaders/cube/cube.vert"
...
$(SHARED_INTERMEDIATE_DIR)/reflect.vert.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=vertex" -o "$(SHARED_INTERMEDIATE_DIR)/reflect.vert.spv" "tests/loadtests/vkloadtests/shaders/cubemap/reflect.vert"
...
$(SHARED_INTERMEDIATE_DIR)/skybox.vert.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=vertex" -o "$(SHARED_INTERMEDIATE_DIR)/skybox.vert.spv" "tests/loadtests/vkloadtests/shaders/cubemap/skybox.vert"
...
$(SHARED_INTERMEDIATE_DIR)/texture.vert.spv \
	...
	"$(VULKAN_SDK)/macOS/bin/glslc" "-fshader-stage=vertex" -o "$(SHARED_INTERMEDIATE_DIR)/texture.vert.spv" "tests/loadtests/vkloadtests/shaders/texture/texture.vert"
