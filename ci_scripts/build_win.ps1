...
echo "Build via $CMAKE_GEN dir: $build_dir Arch: $PLATFORM Config: $CONFIGURATION FEATURE_LOADTESTS: $FEATURE_LOADTESTS FEATURE_DOC: $FEATURE_DOC iFEATURE_JNI: $FEATURE_JNI FEATURE_TOOLS: $FEATURE_TOOLS SUPPORT_SSE: $SUPPORT_SSE SUPPORT_OPENCL: $SUPPORT_OPENCL"
