...
$FEATURE_TOOLS_CTS = Set-Config-Variable FEATURE_TOOLS_CTS "ON"
...
echo "Configure KTX-Software (Windows $CMAKE_GEN) dir: $BUILD_DIR Arch: $PLATFORM Toolset: $CMAKE_TOOLSET FEATURE_LOADTESTS: $FEATURE_LOADTESTS, FEATURE_DOC: $FEATURE_DOC, FEATURE_JNI: $FEATURE_JNI, FEATURE_TESTS: $FEATURE_TESTS, FEATURE_TOOLS: $FEATURE_TOOLS, FEATURE_TOOLS_CTS: $FEATURE_TOOLS_CTS, SUPPORT_SSE: $SUPPORT_SSE, SUPPORT_OPENCL: $SUPPORT_OPENCL WIN_CODE_SIGN_IDENTITY: $WIN_CODE_SIGN_IDENTITY WIN_CS_CERT_SEARCH_MACHINE_STORE: $WIN_CS_CERT_SEARCH_MACHINE_STORE"
