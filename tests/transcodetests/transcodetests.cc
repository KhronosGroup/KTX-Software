...
void test_texture_set(TextureSet& textureSet, FormatFeature& format) {
    ...
    uint32_t bRes =
        basisu.transcodeImage((void*)basisTranscodedData, finalSize, 0, 0, format.format, 0, 0);
    ...
    result = ktxTexture2_CreateFromMemory((const ktx_uint8_t*)data, (ktx_size_t)fsize,
