...
extern void swizzle_to_rgba(uint8_t* rgbadst, uint8_t* rgbasrc, uint32_t src_len, ktx_size_t image_size, swizzle_e swizzle[4]);
...
ktx_uint8_t CheckHeader1Test::ktxId[12] = {0xAB, 0x4B, 0x54, 0x58, 0x20, 0x31, 0x31, 0xBB, 0x0D, 0x0A, 0x1A, 0x0A};

//--------------------------------------------
// Base fixture for WriterTestHelper tests.
//--------------------------------------------

template <typename component_type, ktx_uint32_t num_components, GLenum internalformat>
...
#if defined(DEBUG)
TEST_F(CheckHeader1Test, AssertsOnNullArguments) { ASSERT_DEATH_IF_SUPPORTED(ktxCheckHeader1_(0, 0), "Assert*"); }
#endif
...
class createDFDTestBaseUncomp : public createDFDTestBase<numComponents, bytesPlane> {
  ...
  public:
    ...
    void customize(ktx_uint8_t model, ktx_uint8_t primaries, ktx_uint8_t transfer, ktx_uint8_t flags,
...
class createDFDTestBaseComp : public createDFDTestBase<numComponents, bytesPlane> {
  ...
  public:
    createDFDTestBaseComp() : createDFDTestBase<numComponents, bytesPlane>() { expected.texelBlockDimension3 = 0; }

    void customize(ktx_uint8_t model, ktx_uint8_t primaries, ktx_uint8_t transfer, ktx_uint8_t flags, ktx_uint32_t dim0,
                   ktx_uint32_t dim1, ktx_uint32_t dim2, std::initializer_list<sampleType> samples) {
        expected.model = model;
        expected.primaries = primaries;
        expected.transfer = transfer;
        expected.flags = flags;
    ...
    void customize(ktx_uint8_t model, ktx_uint8_t primaries, ktx_uint8_t transfer, ktx_uint8_t flags, ktx_uint32_t dim0,
                   ktx_uint32_t dim1, std::initializer_list<sampleType> samples) {
...
TEST_F(createDFDUnpackedTest4, FormatSRGBA8) {
    customize(KHR_DF_MODEL_RGBSDA, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_SRGB, KHR_DF_FLAG_ALPHA_STRAIGHT,
              {{0, 7, KHR_DF_CHANNEL_RGBSDA_RED, 0, 0, 0, 0, 0, 255},
               ...
               {24, 7, KHR_DF_CHANNEL_RGBSDA_ALPHA | KHR_DF_SAMPLE_DATATYPE_LINEAR, 0, 0, 0, 0, 0, 255}});
...
TEST_F(createDFDUnpackedTest4, FormatRGBA8) {
    customize(KHR_DF_MODEL_RGBSDA, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_LINEAR, KHR_DF_FLAG_ALPHA_STRAIGHT,
              {{0, 7, KHR_DF_CHANNEL_RGBSDA_RED, 0, 0, 0, 0, 0, 255},
               {8, 7, KHR_DF_CHANNEL_RGBSDA_GREEN, 0, 0, 0, 0, 0, 255},
               {16, 7, KHR_DF_CHANNEL_RGBSDA_BLUE, 0, 0, 0, 0, 0, 255},
...
TEST_F(createDFDPackedTest3, FormatRGB565) {
    ...
    // In order from LSB.
    int bits[] = {5, 6, 5, 0};
    int channels[] = {KHR_DF_CHANNEL_RGBSDA_BLUE, KHR_DF_CHANNEL_RGBSDA_GREEN, KHR_DF_CHANNEL_RGBSDA_RED, 0};
...
TEST_F(createDFDCompressedTest1, FormatETC1S_R8B8G8) {
    customize(KHR_DF_MODEL_ETC1S, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_LINEAR, KHR_DF_FLAG_ALPHA_STRAIGHT, 3, 3,
              {
...
TEST_F(createDFDCompressedTest1, FormatETC1S_SR8B8G8) {
    customize(KHR_DF_MODEL_ETC1S, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_SRGB, KHR_DF_FLAG_ALPHA_STRAIGHT, 3, 3,
              {
                  {0, 63, KHR_DF_CHANNEL_ETC1S_RGB, 0, 0, 0, 0, 0, 0xFFFFFFFF},
              });
...
TEST_F(createDFDCompressedTest1, FormatETC2_R8B8G8) {
    customize(KHR_DF_MODEL_ETC2, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_LINEAR, KHR_DF_FLAG_ALPHA_STRAIGHT, 3, 3,
              {
...
TEST_F(createDFDCompressedTest1, FormatETC2_SR8B8G8) {
    customize(KHR_DF_MODEL_ETC2, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_SRGB, KHR_DF_FLAG_ALPHA_STRAIGHT, 3, 3,
              {
                  {0, 63, KHR_DF_CHANNEL_ETC2_COLOR, 0, 0, 0, 0, 0, 0xFFFFFFFF},
              });
...
TEST_F(createDFDCompressedTest2, FormatETC2_SR8G8B8A8) {
    customize(KHR_DF_MODEL_ETC2, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_SRGB, KHR_DF_FLAG_ALPHA_STRAIGHT, 3, 3,
              {
                  {0, 63, KHR_DF_CHANNEL_ETC2_ALPHA | KHR_DF_SAMPLE_DATATYPE_LINEAR, 0, 0, 0, 0, 0, 0xFFFFFFFF},
                  {64, 63, KHR_DF_CHANNEL_ETC2_COLOR, 0, 0, 0, 0, 0, 0xFFFFFFFF},
              });
...
TEST_F(createDFDCompressedTest1x16, FormatASTC_12x12_SRGB) {
    customize(KHR_DF_MODEL_ASTC, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_SRGB, KHR_DF_FLAG_ALPHA_STRAIGHT, 11, 11,
              {
...
TEST_F(createDFDCompressedTest1x16, FormatASTC_10x5_SRGB) {
    customize(KHR_DF_MODEL_ASTC, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_SRGB, KHR_DF_FLAG_ALPHA_STRAIGHT, 9, 4,
              {
                  {0, 127, KHR_DF_CHANNEL_ASTC_DATA, 0, 0, 0, 0, 0, 0xFFFFFFFF},
              });
...
TEST_F(createDFDCompressedTest1x16, FormatASTC_5x4) {
    customize(KHR_DF_MODEL_ASTC, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_LINEAR, KHR_DF_FLAG_ALPHA_STRAIGHT, 4, 3,
              {
                  {0, 127, KHR_DF_CHANNEL_ASTC_DATA, 0, 0, 0, 0, 0, 0xFFFFFFFF},
              });
...
TEST_F(createDFDCompressedTest1x16, FormatASTC_10x8) {
    customize(KHR_DF_MODEL_ASTC, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_LINEAR, KHR_DF_FLAG_ALPHA_STRAIGHT, 9, 7,
              {
                  {0, 127, KHR_DF_CHANNEL_ASTC_DATA, 0, 0, 0, 0, 0, 0xFFFFFFFF},
              });
...
TEST_F(createDFDCompressedTest1x16, FormatASTC_3x3x3) {
    customize(KHR_DF_MODEL_ASTC, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_LINEAR, KHR_DF_FLAG_ALPHA_STRAIGHT, 2, 2, 2,
              {
                  {0, 127, KHR_DF_CHANNEL_ASTC_DATA, 0, 0, 0, 0, 0, 0xFFFFFFFF},
              });
...
TEST_F(createDFDCompressedTest1, FormatBC1) {
    customize(KHR_DF_MODEL_BC1A, KHR_DF_PRIMARIES_BT709, KHR_DF_TRANSFER_LINEAR, KHR_DF_FLAG_ALPHA_STRAIGHT, 3, 3,
              {
...
TEST_F(DFDVkFormatListTest, ReconstructDFDBytesPlane0) {
    for (uint32_t i = 0; i < sizeof(formats) / sizeof(VkFormat); i++) {
        ...
        ASSERT_TRUE(dfd != NULL) << "vk2dfd failed to produce DFD for " << vkFormatString(formats[i]);
        uint32_t* bdfd = dfd + 1;
...
class HashListTest : public ::testing::Test {
  protected:
    ...
    void constructList(bool sort) {
        ...
        result = ktxHashList_AddKVPair(&head, KTX_WRITER_KEY, (ktx_uint32_t)writerVal.length() + 1, writerVal.c_str());
        EXPECT_EQ(result, KTX_SUCCESS);
        result =
            ktxHashList_AddKVPair(&head, KTX_ORIENTATION_KEY, (ktx_uint32_t)orientationVal.length() + 1, orientationVal.c_str());
        EXPECT_EQ(result, KTX_SUCCESS);
        if (sort) {
    ...
    void checkList() { compareList(head, sorted); }
...
class SwizzleTestBase : public ::testing::Test {
  public:
    ...
    void runTest(swizzle_e swizzle[4]) {
        ...
        helper.texinfo.vkFormat = vkGetFormatFromOpenGLInternalFormat(helper.texinfo.glInternalformat);
        result = ktxTexture2_Create(&helper.texinfo, KTX_TEXTURE_CREATE_ALLOC_STORAGE, &texture);
        ...
        swizzle_to_rgba((uint8_t*)dest, texture->pData, num_components, srcByteLen, swizzle);
