...
class ktxTextureTestBase : public ::testing::Test {
  protected:
	ktxTextureTestBase(ktxFormatVersionEnum fv) :
	    pixelSize(16) {
...
class ktxTexture1TestBase : public ktxTextureTestBase<GLubyte, 4, GL_RGBA8> {
  protected:
	ktxTexture1TestBase() :
	    ktxTextureTestBase(KTX_FORMAT_VERSION_ONE) {
	}
...
class ktxTexture2TestBase : public ktxTextureTestBase<component_type,
  ...
  protected:
	...
	ktxTexture2TestBase() :
	    ktxTextureTestBase<component_type, numComponents, internalformat>(KTX_FORMAT_VERSION_TWO) {
	}
