...
// The actual check for extension presence and enabling it on the device is done in the example base
// class See VulkanExampleBase::createInstance and VulkanExampleBase::createDevice
