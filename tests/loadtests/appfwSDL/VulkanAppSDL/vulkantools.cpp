...
void exitFatal(std::string message, std::string caption) {
    (void)SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR, caption.c_str(), message.c_str(), NULL);
    std::cerr << message << "\n";
    exit(1);
}
...
VkCommandBufferAllocateInfo vkTools::initializers::commandBufferAllocateInfo(VkCommandPool commandPool, VkCommandBufferLevel level,
...
VkDescriptorPoolCreateInfo vkTools::initializers::descriptorPoolCreateInfo(uint32_t poolSizeCount, VkDescriptorPoolSize* pPoolSizes,
                                                                           uint32_t maxSets) {
...
VkDescriptorSetLayoutBinding vkTools::initializers::descriptorSetLayoutBinding(VkDescriptorType type, VkShaderStageFlags stageFlags,
                                                                               uint32_t binding) {
...
VkDescriptorSetLayoutCreateInfo vkTools::initializers::descriptorSetLayoutCreateInfo(const VkDescriptorSetLayoutBinding* pBindings,
...
VkPipelineLayoutCreateInfo vkTools::initializers::pipelineLayoutCreateInfo(const VkDescriptorSetLayout* pSetLayouts,
...
VkDescriptorSetAllocateInfo vkTools::initializers::descriptorSetAllocateInfo(VkDescriptorPool descriptorPool,
...
VkDescriptorImageInfo vkTools::initializers::descriptorImageInfo(VkSampler sampler, VkImageView imageView,
...
VkWriteDescriptorSet vkTools::initializers::writeDescriptorSet(VkDescriptorSet dstSet, VkDescriptorType type, uint32_t binding,
...
VkVertexInputBindingDescription vkTools::initializers::vertexInputBindingDescription(uint32_t binding, uint32_t stride,
...
VkVertexInputAttributeDescription vkTools::initializers::vertexInputAttributeDescription(uint32_t binding, uint32_t location,
...
VkPipelineColorBlendAttachmentState vkTools::initializers::pipelineColorBlendAttachmentState(VkColorComponentFlags colorWriteMask,
...
VkPipelineDepthStencilStateCreateInfo vkTools::initializers::pipelineDepthStencilStateCreateInfo(VkBool32 depthTestEnable,
...
VkPipelineViewportStateCreateInfo vkTools::initializers::pipelineViewportStateCreateInfo(uint32_t viewportCount,
...
VkPipelineDynamicStateCreateInfo vkTools::initializers::pipelineDynamicStateCreateInfo(const VkDynamicState* pDynamicStates,
...
VkGraphicsPipelineCreateInfo vkTools::initializers::pipelineCreateInfo(VkPipelineLayout layout, VkRenderPass renderPass,
...
VkPushConstantRange vkTools::initializers::pushConstantRange(VkShaderStageFlags stageFlags, uint32_t size, uint32_t offset) {
