...
void setImageLayout(VkCommandBuffer cmdbuffer, VkImage image, VkImageAspectFlags /*aspectMask*/,
    ...
    vkCmdPipelineBarrier(cmdbuffer, srcStageFlags, destStageFlags, 0, 0, nullptr, 0, nullptr, 1,
                         &imageMemoryBarrier);
}
...
VkCommandBufferAllocateInfo vkTools::initializers::commandBufferAllocateInfo(
...
VkViewport vkTools::initializers::viewport(float width, float height, float minDepth,
                                           float maxDepth) {
    VkViewport viewport = {};
...
VkRect2D vkTools::initializers::rect2D(int32_t width, int32_t height, int32_t offsetX,
                                       int32_t offsetY) {
    VkRect2D rect2D = {};
...
VkBufferCreateInfo vkTools::initializers::bufferCreateInfo(VkBufferUsageFlags usage,
                                                           VkDeviceSize size) {
    VkBufferCreateInfo bufCreateInfo = {};
    bufCreateInfo.sType = VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO;
...
VkDescriptorPoolSize vkTools::initializers::descriptorPoolSize(VkDescriptorType type,
...
VkDescriptorImageInfo vkTools::initializers::descriptorImageInfo(VkSampler sampler,
...
VkWriteDescriptorSet vkTools::initializers::writeDescriptorSet(VkDescriptorSet dstSet,
...
VkPipelineTessellationStateCreateInfo vkTools::initializers::pipelineTessellationStateCreateInfo(
...
VkComputePipelineCreateInfo vkTools::initializers::computePipelineCreateInfo(
...
VkPushConstantRange vkTools::initializers::pushConstantRange(VkShaderStageFlags stageFlags,
