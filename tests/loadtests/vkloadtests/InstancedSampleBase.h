...
class InstancedSampleBase : public VulkanLoadTestSample {
  public:
    InstancedSampleBase(VulkanContext& vkctx, uint32_t width, uint32_t height,
  ...
  protected:
    ...
    void preparePipelines(const char* const fragShaderName, const char* const vertShaderName,
    ...
    void prepare(const char* const fragShaderName, const char* const vertShaderName,
                 uint32_t instanceCountConstId, uint32_t instanceCount,
