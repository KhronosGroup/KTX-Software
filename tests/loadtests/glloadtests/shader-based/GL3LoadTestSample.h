...
class GL3LoadTestSample : public LoadTestSample {
  public:
    ...
    GL3LoadTestSample(uint32_t width, uint32_t height, const char* const /*szArgs*/,
    ...
    typedef LoadTestSample* (*PFN_create)(uint32_t width, uint32_t height, const char* const szArgs,
                                          const std::string sBasePath);
  ...
  protected:
    ...
    static void makeShader(GLenum type, const GLchar* const source, GLuint* shader);
