...
LoadTestSample* TextureMipmap::create(uint32_t width, uint32_t height, const char* const szArgs,
 ...
 */
TextureMipmap::TextureMipmap(uint32_t width, uint32_t height, const char* const szArgs,
                             const std::string sBasePath)
