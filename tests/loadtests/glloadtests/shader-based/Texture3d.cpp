...
LoadTestSample* Texture3d::create(uint32_t width, uint32_t height, const char* const szArgs,
 ...
 */
Texture3d::Texture3d(uint32_t width, uint32_t height, const char* const szArgs,
                     const std::string sBasePath)
