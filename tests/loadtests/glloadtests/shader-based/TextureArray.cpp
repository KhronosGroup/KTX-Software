...
LoadTestSample* TextureArray::create(uint32_t width, uint32_t height, const char* const szArgs,
 ...
 */
TextureArray::TextureArray(uint32_t width, uint32_t height, const char* const szArgs,
                           const std::string sBasePath)
