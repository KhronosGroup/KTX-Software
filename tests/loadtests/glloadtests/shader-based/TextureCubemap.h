...
class TextureCubemap : public GL3LoadTestSample {
  public:
    TextureCubemap(uint32_t width, uint32_t height, const char* const szArgs,
    ...
    static LoadTestSample* create(uint32_t width, uint32_t height, const char* const szArgs,
                                  const std::string sBasePath);
