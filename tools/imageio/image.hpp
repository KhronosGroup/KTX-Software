        ...
        for (uint32_t i = 0; i < 3; ++i)
            for (uint32_t j = 0; j < 3; ++j) {
                ...
                for (uint32_t k = 0; k < 3; ++k)
                    result.matrix[i][j] +=
                        toXYZ.matrix[i][k] * targetPrimaries.fromXYZ.matrix[k][j];
            }
        return result;
    }
...
struct ColorPrimariesBT709 : public ColorPrimaries {
    ColorPrimariesBT709()
        : ColorPrimaries(
              ColorPrimaryTransform({+0.412391f, +0.357584f, +0.180481f, +0.212639f, +0.715169f,
                                     +0.072192f, +0.019331f, +0.119195f, +0.950532f}),
              ColorPrimaryTransform({+3.240970f, -1.537383f, -0.498611f, -0.969244f, +1.875968f,
                                     +0.041555f, +0.055630f, -0.203977f, +1.056972f})) {}
};

struct ColorPrimariesBT601_625_EBU : public ColorPrimaries {
    ColorPrimariesBT601_625_EBU()
        : ColorPrimaries(
              ColorPrimaryTransform({+0.430554f, +0.341550f, +0.178352f, +0.222004f, +0.706655f,
                                     +0.071341f, +0.020182f, +0.129553f, +0.939322f}),
              ColorPrimaryTransform({+3.063361f, -1.393390f, -0.475824f, -0.969244f, +1.875968f,
                                     +0.041555f, +0.067861f, -0.228799f, +1.069090f})) {}
};

struct ColorPrimariesBT601_525_SMPTE : public ColorPrimaries {
    ColorPrimariesBT601_525_SMPTE()
        : ColorPrimaries(
              ColorPrimaryTransform({+0.393521f, +0.365258f, +0.191677f, +0.212376f, +0.701060f,
                                     +0.086564f, +0.018739f, +0.111934f, +0.958385f}),
              ColorPrimaryTransform({+3.506003f, -1.739791f, -0.544058f, -1.069048f, +1.977779f,
                                     +0.035171f, +0.056307f, -0.196976f, +1.049952f})) {}
};

struct ColorPrimariesBT2020 : public ColorPrimaries {
    ColorPrimariesBT2020()
        : ColorPrimaries(
              ColorPrimaryTransform({+0.636958f, +0.144617f, +0.168881f, +0.262700f, +0.677998f,
                                     +0.059302f, +0.000000f, +0.028073f, +1.060985f}),
              ColorPrimaryTransform({+1.716651f, -0.355671f, -0.253366f, -0.666684f, +1.616481f,
                                     +0.015769f, +0.017640f, -0.042771f, +0.942103f})) {}
};
...
struct ColorPrimariesACES : public ColorPrimaries {
    ColorPrimariesACES()
        : ColorPrimaries(ColorPrimaryTransform({+0.9525523959f, 0.0000000000f, +0.0000936786f,
                                                +0.3439664498f, +0.7281660966f, -0.0721325464f,
                                                0.0000000000f, 0.0000000000f, +1.0088251844f}),
                         ColorPrimaryTransform({+1.0498110175f, 0.0000000000f, -0.0000974845f,
...
struct ColorPrimariesACEScc : public ColorPrimaries {
    ColorPrimariesACEScc()
        : ColorPrimaries(ColorPrimaryTransform({+0.6624541811f, +0.1340042065f, +0.1561876870f,
                         ...
                         ColorPrimaryTransform({+1.6410233797f, -0.3248032942f, -0.2464246952f,
...
struct ColorPrimariesNTSC1953 : public ColorPrimaries {
    ColorPrimariesNTSC1953()
        : ColorPrimaries(
              ColorPrimaryTransform({+0.606993f, +0.173449f, +0.200571f, +0.298967f, +0.586421f,
                                     +0.114612f, +0.000000f, +0.066076f, +1.117469f}),
              ColorPrimaryTransform({+1.909675f, -0.532365f, -0.288161f, -0.984965f, +1.999777f,
                                     -0.028317f, +0.058241f, -0.118246f, +0.896554f})) {}
};

struct ColorPrimariesPAL525 : public ColorPrimaries {
    ColorPrimariesPAL525()
        : ColorPrimaries(
              ColorPrimaryTransform({+0.415394f, +0.354637f, +0.210677f, +0.224181f, +0.680675f,
                                     +0.095145f, +0.019781f, +0.108679f, +1.053387f}),
              ColorPrimaryTransform({+3.321392f, -1.648181f, -0.515410f, -1.101064f, +2.037011f,
                                     +0.036225f, +0.051228f, -0.179211f, +0.955260f})) {}
};

struct ColorPrimariesDisplayP3 : public ColorPrimaries {
    ColorPrimariesDisplayP3()
        : ColorPrimaries(ColorPrimaryTransform({+0.4865709486f, +0.2656676932f, +0.1982172852f,
                                                +0.2289745641f, +0.6917385218f, +0.0792869141f,
                                                0.0000000000f, +0.0451133819f, +1.0439441689f}),
                         ColorPrimaryTransform({+2.4934969119f, -0.9313836179f, -0.4027107845f,
...
struct ColorPrimariesAdobeRGB : public ColorPrimaries {
    ColorPrimariesAdobeRGB()
        : ColorPrimaries(ColorPrimaryTransform({+0.5766690429f, +0.1855582379f, +0.1882286462f,
                                                +0.2973449753f, +0.6273635663f, +0.0752914585f,
                                                +0.0270313614f, +0.0706888525f, +0.9913375368f}),
                         ColorPrimaryTransform({+2.0415879038f, -0.5650069743f, -0.3447313508f,
...
class Image {
  public:
    ...
    /// Should only be used if the stored image data is UNORM convertable (with optional significant
    /// bit count)
    virtual std::vector<uint8_t> getUNORM(uint32_t numChannels, uint32_t targetBits,
                                          uint32_t sBits = 0) const = 0;
    /// Should only be used if the stored image data is UNORM convertable (packed into a single
    /// word)
    virtual std::vector<uint8_t> getUNORMPacked(uint32_t c0, uint32_t c1, uint32_t c2,
                                                uint32_t c3) const = 0;
    ...
    /// Should only be used if the stored image data is UINT convertable
    virtual std::vector<uint8_t> getUINTPacked(uint32_t c0, uint32_t c1, uint32_t c2,
                                               uint32_t c3) const = 0;
    /// Should only be used if the stored image data is SINT convertable
    virtual std::vector<uint8_t> getSINTPacked(uint32_t c0, uint32_t c1, uint32_t c2,
                                               uint32_t c3) const = 0;
    virtual std::unique_ptr<Image> resample(uint32_t targetWidth, uint32_t targetHeight,
                                            const char* filter, float filterScale,
                                            basisu::Resampler::Boundary_Op wrapMode) = 0;
    virtual Image& yflip() = 0;
    virtual Image& transformColorSpace(
        const TransferFunction& decode, const TransferFunction& encode,
...
class ImageT : public Image {
  ...
  public:
    ...
    ImageT(uint32_t w, uint32_t h, Color* pixels)
        : Image(w, h), pixels(pixels), freePixels(false) {}
    ...
    virtual std::vector<uint8_t> getUNORM(uint32_t numChannels, uint32_t targetBits,
        ...
        const uint32_t mask =
            (sBits == 0) ? 0xFFFFFFFF : ((1u << sBits) - 1u) << (targetBits - sBits);
        std::vector<uint8_t> data(height * width * numChannels * targetBytes);

        for (uint32_t y = 0; y < height; ++y) {
            for (uint32_t x = 0; x < width; ++x) {
                for (uint32_t c = 0; c < numChannels; ++c) {
                    const auto sourceValue = c < componentCount
                                                 ? pixels[y * width + x][c]
                                                 : (c != 3 ? componentType{0} : Color::one());
                    const auto value = imageio::convertUNORM(static_cast<uint32_t>(sourceValue),
                                                             sourceBits, targetBits);
                    auto* target =
                        data.data() + (y * width * numChannels + x * numChannels + c) * targetBytes;
    ...
    virtual std::vector<uint8_t> getUNORMPacked(uint32_t c0, uint32_t c1, uint32_t c2,
                                                uint32_t c3) const override {
        assert((c0 + c1 + c2 + c3) % 8 == 0);
        const auto targetPackBytes = (c0 + c1 + c2 + c3) / 8;
        assert(targetPackBytes == 1 || targetPackBytes == 2 || targetPackBytes == 4 ||
               targetPackBytes == 8);
        ...
        const auto numChannels =
            (packC0 ? 1u : 0) + (packC1 ? 1u : 0) + (packC2 ? 1u : 0) + (packC3 ? 1u : 0);
        assert(numChannels <= componentCount);
        (void)numChannels;
        const uint32_t sourceBits = sizeof(componentType) * 8;
    ...
    virtual std::vector<uint8_t> getSFloat(uint32_t numChannels,
                                           uint32_t targetBits) const override {
        assert(numChannels <= componentCount);
        ...
        for (uint32_t y = 0; y < height; ++y) {
            for (uint32_t x = 0; x < width; ++x) {
                for (uint32_t c = 0; c < numChannels; ++c) {
                    const auto value = c < componentCount
                                           ? pixels[y * width + x][c]
                                           : (c != 3 ? componentType{0} : componentType{1});
                    auto* target =
                        data.data() + (y * width * numChannels + x * numChannels + c) * targetBytes;
    ...
    virtual std::vector<uint8_t> getUINT(uint32_t numChannels, uint32_t targetBits) const override {
        ...
        for (uint32_t y = 0; y < height; ++y) {
            for (uint32_t x = 0; x < width; ++x) {
                for (uint32_t c = 0; c < numChannels; ++c) {
                    const auto value = c < componentCount ? pixels[y * width + x][c]
                                       : c != 3           ? 0
                                                          : componentType{1};
                    auto* target =
                        data.data() + (y * width * numChannels + x * numChannels + c) * targetBytes;
    ...
    virtual std::vector<uint8_t> getUINTPacked(uint32_t c0, uint32_t c1, uint32_t c2,
        ...
        for (uint32_t y = 0; y < height; ++y) {
            for (uint32_t x = 0; x < width; ++x) {
                ...
                uint32_t pack = 0;
                pack |=
                    imageio::convertUINT(static_cast<uint32_t>(pixel[0]), sizeof(uint32_t) * 8, c0)
                    << (c1 + c2 + c3);
                pack |=
                    imageio::convertUINT(static_cast<uint32_t>(pixel[1]), sizeof(uint32_t) * 8, c1)
                    << (c2 + c3);
                pack |=
                    imageio::convertUINT(static_cast<uint32_t>(pixel[2]), sizeof(uint32_t) * 8, c2)
                    << c3;
                pack |=
                    imageio::convertUINT(static_cast<uint32_t>(pixel[3]), sizeof(uint32_t) * 8, c3);
    ...
    virtual std::vector<uint8_t> getSINTPacked(uint32_t c0, uint32_t c1, uint32_t c2,
        ...
        for (uint32_t y = 0; y < height; ++y) {
            for (uint32_t x = 0; x < width; ++x) {
                ...
                uint32_t pack = 0;
                pack |= imageio::convertSINT(
                            imageio::bit_cast<uint32_t>(static_cast<int32_t>(pixel[0])),
                            sizeof(uint32_t) * 8, c0)
                        << (c1 + c2 + c3);
                pack |= imageio::convertSINT(
                            imageio::bit_cast<uint32_t>(static_cast<int32_t>(pixel[1])),
                            sizeof(uint32_t) * 8, c1)
                        << (c2 + c3);
                pack |= imageio::convertSINT(
                            imageio::bit_cast<uint32_t>(static_cast<int32_t>(pixel[2])),
                            sizeof(uint32_t) * 8, c2)
                        << c3;
                pack |= imageio::convertSINT(
                    imageio::bit_cast<uint32_t>(static_cast<int32_t>(pixel[3])),
                    sizeof(uint32_t) * 8, c3);
    ...
    virtual std::unique_ptr<Image> resample(uint32_t targetWidth, uint32_t targetHeight,
        ...
        auto target =
            std::make_unique<ImageT<componentType, componentCount>>(targetWidth, targetHeight);
        target->setOetf(oetf);
        ...
        if (std::max(sourceWidth, sourceHeight) > BASISU_RESAMPLER_MAX_DIMENSION ||
            ...
            throw std::runtime_error(fmt::format("Image larger than max supported size of {}",
        ...
        for (uint32_t i = 0; i < componentCount; ++i) {
            resamplers[i] = std::make_unique<Resampler>(
                sourceWidth, sourceHeight, targetWidth, targetHeight, wrapMode, 0.0f,
                isHDR ? 0.0f : 1.0f, filter, i == 0 ? nullptr : resamplers[0]->get_clist_x(),
                i == 0 ? nullptr : resamplers[0]->get_clist_y(), filterScale, filterScale, 0.f,
                0.f);
        ...
        for (uint32_t sourceY = 0; sourceY < sourceHeight; ++sourceY) {
            ...
            for (uint32_t sourceX = 0; sourceX < sourceWidth; ++sourceX) {
                ...
                for (uint32_t c = 0; c < componentCount; ++c) {
                    const float value = std::is_floating_point_v<componentType>
                                            ? sourcePixel[c]
                                            : static_cast<float>(sourcePixel[c]) *
                                                  (1.f / static_cast<float>(Color::one()));
            ...
            while (true) {
                ...
                if (outputLine[0] == nullptr)
                    break;  // No new output line, break from retrieve and place in a new source
                            // line
                            ...
                            const auto unormValue =
                                ...
                                : outValue > 1.f
                                    ...
                                    : static_cast<componentType>(
                                          outValue * static_cast<float>(Color::one()) + 0.5f);
    ...
    virtual ImageT& transformColorSpace(const TransferFunction& decode,
                                        const TransferFunction& encode,
        ...
        for (uint32_t i = 0; i < pixelCount; ++i) {
            ...
            for (uint32_t comp = 0; comp < components; comp++) {
                ...
                // clamp(value, color::min, color::max) is required as static_cast has
                // platform-specific behaviors and on certain platforms can over or underflow
                c.set(comp,
                      cclamp(roundf(brightness[comp] * static_cast<float>(Color::one())),
                             static_cast<float>(Color::min()), static_cast<float>(Color::max())));
            }
        }
        return *this;
    }
