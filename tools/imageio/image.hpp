...
template <typename T>
inline T cclamp(T value, T low, T high) {
...
struct ColorPrimaryTransform {
    ...
    ColorPrimaryTransform(const std::vector<float>& elements) {
        for (uint32_t i = 0; i < 3; ++i)
            for (uint32_t j = 0; j < 3; ++j) matrix[i][j] = elements[i * 3 + j];
    }
...
struct TransferFunctionLinear : public TransferFunction {
    float encode(const float intensity) const override { return intensity; }
    float decode(const float brightness) const override { return brightness; }
};
...
struct TransferFunctionGamma : public TransferFunction {
    ...
    float encode(const float intensity) const override { return saturate(powf(intensity, oeGamma_)); }

    float decode(const float brightness) const override { return saturate(powf(brightness, eoGamma_)); }
    ...
    ColorPrimaryTransform transformTo(const ColorPrimaries& targetPrimaries) const {
        ...
        for (uint32_t i = 0; i < 3; ++i)
            for (uint32_t j = 0; j < 3; ++j) {
                result.matrix[i][j] = 0;
                for (uint32_t k = 0; k < 3; ++k) result.matrix[i][j] += toXYZ.matrix[i][k] * targetPrimaries.fromXYZ.matrix[k][j];
            }
        return result;
    }
...
struct ColorPrimariesBT709 : public ColorPrimaries {
    ColorPrimariesBT709()
        : ColorPrimaries(ColorPrimaryTransform({+0.412391f, +0.357584f, +0.180481f, +0.212639f, +0.715169f, +0.072192f, +0.019331f,
                                                +0.119195f, +0.950532f}),
                         ColorPrimaryTransform({+3.240970f, -1.537383f, -0.498611f, -0.969244f, +1.875968f, +0.041555f, +0.055630f,
                                                -0.203977f, +1.056972f})) {}
};

struct ColorPrimariesBT601_625_EBU : public ColorPrimaries {
    ColorPrimariesBT601_625_EBU()
        : ColorPrimaries(ColorPrimaryTransform({+0.430554f, +0.341550f, +0.178352f, +0.222004f, +0.706655f, +0.071341f, +0.020182f,
                                                +0.129553f, +0.939322f}),
                         ColorPrimaryTransform({+3.063361f, -1.393390f, -0.475824f, -0.969244f, +1.875968f, +0.041555f, +0.067861f,
                                                -0.228799f, +1.069090f})) {}
};

struct ColorPrimariesBT601_525_SMPTE : public ColorPrimaries {
    ColorPrimariesBT601_525_SMPTE()
        : ColorPrimaries(ColorPrimaryTransform({+0.393521f, +0.365258f, +0.191677f, +0.212376f, +0.701060f, +0.086564f, +0.018739f,
                                                +0.111934f, +0.958385f}),
                         ColorPrimaryTransform({+3.506003f, -1.739791f, -0.544058f, -1.069048f, +1.977779f, +0.035171f, +0.056307f,
                                                -0.196976f, +1.049952f})) {}
};

struct ColorPrimariesBT2020 : public ColorPrimaries {
    ColorPrimariesBT2020()
        : ColorPrimaries(ColorPrimaryTransform({+0.636958f, +0.144617f, +0.168881f, +0.262700f, +0.677998f, +0.059302f, +0.000000f,
                                                +0.028073f, +1.060985f}),
                         ColorPrimaryTransform({+1.716651f, -0.355671f, -0.253366f, -0.666684f, +1.616481f, +0.015769f, +0.017640f,
                                                -0.042771f, +0.942103f})) {}
};

struct ColorPrimariesCIEXYZ : public ColorPrimaries {
    ColorPrimariesCIEXYZ()
        : ColorPrimaries(ColorPrimaryTransform({1.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 1.f}),
                         ColorPrimaryTransform({1.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 1.f})) {}
};

struct ColorPrimariesACES : public ColorPrimaries {
    ColorPrimariesACES()
        : ColorPrimaries(ColorPrimaryTransform({+0.9525523959f, 0.0000000000f, +0.0000936786f, +0.3439664498f, +0.7281660966f,
                                                -0.0721325464f, 0.0000000000f, 0.0000000000f, +1.0088251844f}),
                         ColorPrimaryTransform({+1.0498110175f, 0.0000000000f, -0.0000974845f, -0.4959030231f, +1.3733130458f,
                                                +0.0982400361f, 0.0000000000f, 0.0000000000f, +0.9912520182f})) {}
};

struct ColorPrimariesACEScc : public ColorPrimaries {
    ColorPrimariesACEScc()
        : ColorPrimaries(ColorPrimaryTransform({+0.6624541811f, +0.1340042065f, +0.1561876870f, +0.2722287168f, +0.6740817658f,
                                                +0.0536895174f, -0.0055746495f, +0.0040607335f, +1.0103391003f}),
                         ColorPrimaryTransform({+1.6410233797f, -0.3248032942f, -0.2464246952f, -0.6636628587f, +1.6153315917f,
                                                +0.0167563477f, +0.0117218943f, -0.0082844420f, +0.9883948585f})) {}
};

struct ColorPrimariesNTSC1953 : public ColorPrimaries {
    ColorPrimariesNTSC1953()
        : ColorPrimaries(ColorPrimaryTransform({+0.606993f, +0.173449f, +0.200571f, +0.298967f, +0.586421f, +0.114612f, +0.000000f,
                                                +0.066076f, +1.117469f}),
                         ColorPrimaryTransform({+1.909675f, -0.532365f, -0.288161f, -0.984965f, +1.999777f, -0.028317f, +0.058241f,
                                                -0.118246f, +0.896554f})) {}
};

struct ColorPrimariesPAL525 : public ColorPrimaries {
    ColorPrimariesPAL525()
        : ColorPrimaries(ColorPrimaryTransform({+0.415394f, +0.354637f, +0.210677f, +0.224181f, +0.680675f, +0.095145f, +0.019781f,
                                                +0.108679f, +1.053387f}),
                         ColorPrimaryTransform({+3.321392f, -1.648181f, -0.515410f, -1.101064f, +2.037011f, +0.036225f, +0.051228f,
                                                -0.179211f, +0.955260f})) {}
};

struct ColorPrimariesDisplayP3 : public ColorPrimaries {
    ColorPrimariesDisplayP3()
        : ColorPrimaries(ColorPrimaryTransform({+0.4865709486f, +0.2656676932f, +0.1982172852f, +0.2289745641f, +0.6917385218f,
                                                +0.0792869141f, 0.0000000000f, +0.0451133819f, +1.0439441689f}),
                         ColorPrimaryTransform({+2.4934969119f, -0.9313836179f, -0.4027107845f, -0.8294889696f, +1.7626640603f,
                                                +0.0236246858f, +0.0358458302f, -0.0761723893f, +0.9568845240f})) {}
};

struct ColorPrimariesAdobeRGB : public ColorPrimaries {
    ColorPrimariesAdobeRGB()
        : ColorPrimaries(ColorPrimaryTransform({+0.5766690429f, +0.1855582379f, +0.1882286462f, +0.2973449753f, +0.6273635663f,
                                                +0.0752914585f, +0.0270313614f, +0.0706888525f, +0.9913375368f}),
                         ColorPrimaryTransform({+2.0415879038f, -0.5650069743f, -0.3447313508f, -0.9692436363f, +1.8759675015f,
                                                +0.0415550574f, +0.0134442806f, -0.1183623922f, +1.0151749944f})) {}
};
...
class color_base {
  public:
    ...
    constexpr static uint32_t getPixelSize() { return componentCount * sizeof(componentType); }
    ...
    constexpr static componentType min() { return std::numeric_limits<componentType>::min(); }
    constexpr static componentType max() { return std::numeric_limits<componentType>::max(); }
    componentType clamp(componentType value) { return (value < min()) ? min() : ((value > max()) ? max() : value); }
};
...
class color<componentType, 4> : public color_base<componentType, 4> {
  public:
    ...
    color() {}
    color(componentType _r, componentType _g, componentType _b, componentType _a) : r(_r), g(_g), b(_b), a(_a) {}
    ...
    constexpr uint32_t comps_count() const { return 4; }
    void normalize() {
...
class color<componentType, 3> : public color_base<componentType, 3> {
  public:
    ...
    color() {}
    color(componentType _r, componentType _g, componentType _b) : r(_r), g(_g), b(_b) {}
    color(componentType _r, componentType _g, componentType _b, componentType) : r(_r), g(_g), b(_b) {}
    const componentType& operator[](unsigned int i) const {
        if (i > 2) i = 2;
        return comps[i];
    }
    ...
    constexpr uint32_t comps_count() const { return 3; }
    void normalize() {
        vec3<componentType> v((float)r, (float)g, (float)b);
        v.normalize();
        r = (componentType)v.r;
...
class color<componentType, 2> : public color_base<componentType, 2> {
  public:
    ...
    color() {}
    color(componentType _r, componentType _g) : r(_r), g(_g) {}
    color(componentType _r, componentType _g, componentType, componentType) : r(_r), g(_g) {}
    const componentType& operator[](unsigned int i) const {
        if (i > 1) i = 1;
        return comps[i];
    }
    ...
    constexpr uint32_t comps_count() const { return 2; }
    void normalize() {
        vec3<componentType> v((float)r, (float)g, (float)gc_s[sizeof(componentType)] * 0.5f);
        v.normalize();
        r = (componentType)v.r;
        g = (componentType)v.g;
    }
...
class color<componentType, 1> : public color_base<componentType, 1> {
  public:
    ...
    color() {}
    color(componentType _r) : r(_r) {}
    color(componentType _r, componentType, componentType, componentType) : r(_r) {}
    const componentType& operator[](unsigned int i) const {
        if (i > 0) i = 0;
        return comps[i];
    }
...
class Image {
  public:
    ...
    void setPrimaries(khr_df_primaries_e nprimaries) { this->primaries = nprimaries; }
    ...
    virtual std::vector<uint8_t> getUNORMPacked(uint32_t c0, uint32_t c1, uint32_t c2, uint32_t c3) const = 0;
    ...
    virtual std::unique_ptr<Image> resample(uint32_t targetWidth, uint32_t targetHeight, const char* filter, float filterScale,
                                            basisu::Resampler::Boundary_Op wrapMode) = 0;
  ...
  protected:
    Image() : Image(0, 0) {}
    Image(uint32_t w, uint32_t h) : width(w), height(h), oetf(KHR_DF_TRANSFER_UNSPECIFIED), primaries(KHR_DF_PRIMARIES_BT709) {}
  ...
  public:
    ...
    ImageT(uint32_t w, uint32_t h) : Image(w, h) {
        ...
        for (uint32_t p = 0; p < w * h; ++p)
            for (uint32_t c = 0; c < componentCount; ++c) pixels[p].comps[c] = componentType{0};
    }
    ...
    virtual size_t getByteCount() const override { return getPixelCount() * sizeof(Color); }

    virtual uint32_t getPixelSize() const override { return Color::getPixelSize(); }
    virtual uint32_t getComponentCount() const override { return Color::getComponentCount(); }
    virtual uint32_t getComponentSize() const override { return Color::getComponentSize(); }
            ...
            for (uint32_t x = 0; x < width; ++x) {
                for (uint32_t c = 0; c < numChannels; ++c) {
                    const auto sourceValue =
                        c < componentCount ? pixels[y * width + x][c] : (c != 3 ? componentType{0} : Color::one());
    ...
    virtual std::vector<uint8_t> getUNORMPacked(uint32_t c0, uint32_t c1, uint32_t c2, uint32_t c3) const override {
    ...
    virtual std::vector<uint8_t> getSFloat(uint32_t numChannels, uint32_t targetBits) const override {
        ...
        for (uint32_t y = 0; y < height; ++y) {
            for (uint32_t x = 0; x < width; ++x) {
                for (uint32_t c = 0; c < numChannels; ++c) {
                    const auto value =
                        c < componentCount ? pixels[y * width + x][c] : (c != 3 ? componentType{0} : componentType{1});
                    auto* target = data.data() + (y * width * numChannels + x * numChannels + c) * targetBytes;
    ...
    virtual std::vector<uint8_t> getSINTPacked(uint32_t c0, uint32_t c1, uint32_t c2, uint32_t c3) const override {
        ...
        for (uint32_t y = 0; y < height; ++y) {
            for (uint32_t x = 0; x < width; ++x) {
                ...
                uint32_t pack = 0;
                pack |= imageio::convertSINT(imageio::bit_cast<uint32_t>(static_cast<int32_t>(pixel[0])), sizeof(uint32_t) * 8, c0)
                        << (c1 + c2 + c3);
                pack |= imageio::convertSINT(imageio::bit_cast<uint32_t>(static_cast<int32_t>(pixel[1])), sizeof(uint32_t) * 8, c1)
                        << (c2 + c3);
                pack |= imageio::convertSINT(imageio::bit_cast<uint32_t>(static_cast<int32_t>(pixel[2])), sizeof(uint32_t) * 8, c2)
                        << c3;
    ...
    virtual std::unique_ptr<Image> resample(uint32_t targetWidth, uint32_t targetHeight, const char* filter, float filterScale,
                                            basisu::Resampler::Boundary_Op wrapMode) override {
        ...
        if (std::max(sourceWidth, sourceHeight) > BASISU_RESAMPLER_MAX_DIMENSION ||
            ...
            throw std::runtime_error(fmt::format("Image larger than max supported size of {}", BASISU_RESAMPLER_MAX_DIMENSION));
        }
        ...
        for (uint32_t i = 0; i < componentCount; ++i) {
            resamplers[i] =
                std::make_unique<Resampler>(sourceWidth, sourceHeight, targetWidth, targetHeight, wrapMode, 0.0f,
                                            isHDR ? 0.0f : 1.0f, filter, i == 0 ? nullptr : resamplers[0]->get_clist_x(),
                                            i == 0 ? nullptr : resamplers[0]->get_clist_y(), filterScale, filterScale, 0.f, 0.f);
        ...
        const TransferFunction& tf = oetf == KHR_DF_TRANSFER_SRGB ? static_cast<const TransferFunction&>(tfSRGB)
        ...
        for (uint32_t sourceY = 0; sourceY < sourceHeight; ++sourceY) {
            ...
            for (uint32_t c = 0; c < componentCount; ++c)
                if (!resamplers[c]->put_line(&samples[c][0])) checkResamplerStatus(*resamplers[c], filter);

            // Retrieve any output lines
            while (true) {
                std::array<const float*, componentCount> outputLine{nullptr};
                for (uint32_t c = 0; c < componentCount; ++c) outputLine[c] = resamplers[c]->get_line();

                if (outputLine[0] == nullptr) break;  // No new output line, break from retrieve and place in a new source line
        ...
        for (uint32_t i = 0; i < pixelCount; ++i) {
            ...
            if (transformPrimaries != nullptr) {
                ...
                for (uint32_t j = 0; j < components; ++j) {
                    intensity[j] = 0.f;
                    for (uint32_t k = 0; k < components; ++k) intensity[j] += transformPrimaries->matrix[j][k] * origIntensity[k];
                }
            }
            ...
            for (uint32_t comp = 0; comp < components; comp++) {
                ...
                c.set(comp, cclamp(roundf(brightness[comp] * static_cast<float>(Color::one())), static_cast<float>(Color::min()),
    ...
    virtual ImageT& copyToR(Image& dst, std::string_view swizzle) override {
        return copyTo((ImageT<componentType, 1>&)dst, swizzle);
    }
    virtual ImageT& copyToRG(Image& dst, std::string_view swizzle) override {
        return copyTo((ImageT<componentType, 2>&)dst, swizzle);
    }
    virtual ImageT& copyToRGB(Image& dst, std::string_view swizzle) override {
        return copyTo((ImageT<componentType, 3>&)dst, swizzle);
    }
    virtual ImageT& copyToRGBA(Image& dst, std::string_view swizzle) override {
        return copyTo((ImageT<componentType, 4>&)dst, swizzle);
    }
