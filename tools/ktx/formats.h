...
[[nodiscard]] inline std::string toString(VkFormat format) noexcept {
    ...
    if (str != "VK_UNKNOWN_FORMAT") return str;
...
[[nodiscard]] inline std::string toString(khr_df_vendorid_e vendorId,
                                          khr_df_khr_descriptortype_e descType) noexcept {
...
[[nodiscard]] inline std::string toString(khr_df_model_e colorModel,
                                          khr_df_model_channels_e channelType) noexcept {
...
[[nodiscard]] inline std::optional<VkFormat> parseVkFormat(const std::string& str) noexcept {
    ...
    if (vkFormat == VK_FORMAT_UNDEFINED) return std::nullopt;
    return vkFormat;
}

// -------------------------------------------------------------------------------------------------

[[nodiscard]] constexpr inline bool isSupercompressionWithGlobalData(
    ktxSupercmpScheme scheme) noexcept {
    switch (scheme) {
...
[[nodiscard]] constexpr inline bool isSupercompressionWithNoGlobalData(
    ktxSupercmpScheme scheme) noexcept {
    switch (scheme) {
    case KTX_SS_ZSTD:
    case KTX_SS_ZLIB:
...
[[nodiscard]] constexpr inline bool isColorModelBlockCompressed(
    khr_df_model_e colorModel) noexcept {
...
[[nodiscard]] inline bool isChannelTypeValid(khr_df_model_e colorModel,
                                             khr_df_model_channels_e channelType) noexcept {
...
[[nodiscard]] inline khr_df_model_e getColorModelForBlockCompressedFormat(
...
[[nodiscard]] constexpr inline bool isSupercompressionBlockCompressed(
    ktxSupercmpScheme scheme) noexcept {
    switch (scheme) {
    case KTX_SS_BASIS_LZ:
        return true;
