...
struct Issue {
    ...
    constexpr inline Issue(IssueType type, IssueID id, std::string_view message,
                           std::string_view detailsFmt)
        : type(type), id(id), message(message), detailsFmt(detailsFmt) {}
};
...
struct IOError {
    static constexpr IssueFatal FileOpen{1001, "Failed to open file.",
                                         "Failed to open file {}: {}."};
    ...
    static constexpr IssueFatal UnexpectedEOF{
        ...
        "Unexpected end of file. Failed to read {} byte(s) at offset {} to access {}. Only able to "
        "read {} byte(s)."};
    ...
    // };
    static constexpr IssueFatal RewindFailure{1006, "Failed to seek to the start of the file.",
                                              "Failed to seek to the start of the file: {}."};
    static constexpr IssueFatal FileSeekFailure{
        1007, "Failed to seek in the file.", "Failed to seek to {} to access {}. File error {}."};
};

struct FileError {
    static constexpr IssueFatal NotKTX2{2001, "Not a KTX2 file.",
                                        "Not a KTX2 file. The beginning of the file does not match "
                                        "the expected file identifier \"«KTX 20»\\r\\n\\x1A\\n\"."};
...
struct HeaderData {
    ...
    static constexpr IssueError ProhibitedFormat{3001, "Prohibited VkFormat.",
                                                 "VkFormat {} is prohibited in a KTX2 file."};
    static constexpr IssueError InvalidFormat{3002, "Invalid VkFormat.", "Invalid VkFormat {}."};
    ...
    static constexpr IssueError WidthZero{3006, "Invalid pixelWidth. pixelWidth must not be 0.",
    ...
    static constexpr IssueError DepthNoHeight{
        ...
        "pixelHeight is 0 and pixelDepth is {} but pixelHeight must not be 0 if pixelDepth is not "
        "0 as well."};
    static constexpr IssueError DepthBlockCompressedNoDepth{
        3010,
        "Invalid pixelDepth. pixelDepth must not be 0 for block-compressed formats with non-zero "
        "block depth.",
        "pixelDepth is 0 but for {} (which is a block-compressed format with non-zero block depth) "
        "it must not be 0."};
    ...
    static constexpr IssueError InvalidFaceCount{
        3015,
        "Invalid faceCount. faceCount must be either 6 for Cubemaps and Cubemap Arrays or 1 "
        "otherwise.",
    ...
    static constexpr IssueWarning VendorSupercompression{
        ...
        "supercompressionScheme is {} which falls into the reserved vendor range. Cannot "
        "validate."};
    static constexpr IssueError InvalidSupercompression{3019, "Invalid supercompressionScheme.",
    ...
    static constexpr IssueError IndexDFDInvalidOffset{
        ...
        "dfdByteOffset is {} but the Data Format Descriptor must immediately follow (with 4 byte "
        "alignment) the Level Index so it must be {}."};
    static constexpr IssueError IndexKVDInvalidOffset{
        3022, "Invalid kvdByteOffset.",
        "kvdByteOffset is {} but the Key/Value Data must immediately follow (with 4 byte "
        "alignment) the Data Format Descriptor so it must be {}."};
    ...
    static constexpr IssueError IndexSGDInvalidOffset{
        ...
        "sgdByteOffset is {} but the Supercompression Global Data must immediately follow (with 8 "
        "byte alignment) the preceding block so it must be {}."};
    ...
    static constexpr IssueError IndexSGDMissing{
        ...
        "sgdByteLength is 0 but for supercompression scheme {} (which has global data) it must not "
        "be 0."};
    static constexpr IssueError IndexSGDNotApplicable{
        ...
        "sgdByteLength is {} but for supercompression scheme {} (which does not have global data) "
        "it must be 0."};
    static constexpr IssueError IndexDFDInvalidLength{
        3028,
        "Invalid dfdByteLength. If there is Key/Value Data the dfdByteLength/dfdTotalSize must be "
        "equal to kvdByteOffset - dfdByteOffset.",
    ...
    static constexpr IssueError InvalidSupercompressionGLTFBU{
        ...
        "supercompressionScheme is {} but it must either be BASIS_LZ for ETC1S or either NONE or "
        "ZSTD for UASTC textures for KHR_texture_basisu compatibility."};
    static constexpr IssueError InvalidTextureTypeGLTFBU{
        3102, "Texture type must be 2D for KHR_texture_basisu compatibility.",
        "Texture type is not 2D as {} is {} instead of {} which is incompatible with "
        "KHR_texture_basisu requirements."};
    static constexpr IssueError InvalidPixelWidthHeightGLTFBU{
        3103,
        "pixelWidth and pixelHeight must be multiples of 4 for KHR_texture_basisu compatibility.",
        "{} is {} which is not an integer multiple of 4 as required for KHR_texture_basisu "
        "compatibility."};
    static constexpr IssueError InvalidLevelCountGLTFBU{
        3104,
        "When multiple mip levels are present KHR_texture_basisu requires a full mip pyramid.",
        "levelCount is {} but it must be 1 (single level) or {} (full mip pyramid) for "
        "KHR_texture_basisu compatibility."};
};
...
struct LevelIndex {
    ...
    static constexpr IssueError IncorrectIndexOrder{
        4001,
        "Invalid Level Index. Indices must be sorted from the largest level to the smallest level.",
        "Indexes for level {} with uncompressedByteLength {} and level {} with "
        "uncompressedByteLength {} are incorrectly ordered."};
    static constexpr IssueError IncorrectLevelOrder{
        4002,
        "Invalid Level Index. Level images must be sorted from the smallest level to the largest "
        "level in the file.",
        "Level Image for level {} with byteOffset {} and level {} with byteOffset {} are "
        "incorrectly ordered."};

    static constexpr IssueError IncorrectByteOffsetUnaligned{
        4003,
        "Invalid byteOffset in Level Index. byteOffset has to be aligned to lcm(texel_block_size, "
        "4) and must match expected value.",
        "Level {} byteOffset is {} but based on the vkFormat, DFD and image sizes the required "
        "alignment is {} and the expected value is {}."};
    static constexpr IssueError IncorrectByteOffset{
        ...
        "Level {} byteOffset is {} but based on the vkFormat, DFD and image sizes the expected "
        "value is {}."};
    ...
    static constexpr IssueError IncorrectByteLength{
        ...
        "Level {} byteLength is {} but based on the vkFormat, DFD and image sizes the expected "
        "value is {}."};

    static constexpr IssueError IncorrectUncompressedByteLength{
        4006,
        "Invalid uncompressedByteLength in Level Index. For non-supercompressed files the "
        "uncompressedByteLength must match the expected value of byteLength.",
        "Level {} uncompressedByteLength is {} but based on the vkFormat, DFD and image sizes the "
        "expected value is {}."};
    static constexpr IssueError NonZeroUBLForBLZE{
        4007,
        "Invalid uncompressedByteLength in Level Index. For BasisLZ supercompression "
        "uncompressedByteLength must be 0.",
    ...
    static constexpr IssueError UncompressedByteLengthMismatch{
        4008,
        "Mismatch between uncompresedByteLength in Level Index and actually decompressed bytes.",
        "Decompressing supercompression {} resulted in a different number of bytes than expected "
        "according to uncompressedByteLength."};
    static constexpr IssueError ZeroUncompressedLength{
        4009,
        "Invalid uncompressedByteLength in Level Index. For non-BasisLZ files with "
        "VK_FORMAT_UNDEFINED uncompressedByteLength must not be 0.",
        "Level {} uncompressedByteLength is 0 but for non-BasisLZ files with VK_FORMAT_UNDEFINED "
        "uncompressedByteLength must not be 0."};
    static constexpr IssueError InvalidUncompressedLength{
        4010,
        "Invalid uncompressedByteLength in Level Index. uncompressedByteLength must be equally "
        "divisible between every face and layer.",
        "Level {} uncompressedByteLength is {} but it must be divisible with faceCount * max(1, "
        "layerCount)."};
};
...
struct Validator {
    ...
    static constexpr IssueWarning SupportedNonConformantFile{
        ...
        "KTX 2.0 file does not conform to the specification but it is currently accepted by "
        "libktx."};
...
struct DFD {
    ...
    static constexpr IssueWarning TooManyDFDBlocks{
        ...
        "The number of DFD blocks exceeds the validator limit of {}. Skipping validation of the "
        "remaining {} byte(s)."};
    ...
    static constexpr IssueWarning MultipleBDFD{6005, "Multiple basic DFD blocks.",
                                               "DFD block #{} is a basic DFD block but one was "
                                               "already processed before. It will be ignored."};
    ...
    static constexpr IssueError MissingBDFD{6008, "Missing basic DFD block.",
                                            "No basic data format descriptor block is found in the "
                                            "DFD, or it is not the first DFD block."};
    ...
    static constexpr IssueError BasicDescriptorBlockSizeInvalid{
        ...
        "DFD block #{} descriptorBlockSize is {} which does not fit the criteria "
        "(descriptorBlockSize - 24) % 16 == 0 for basic DFD blocks."};
    static constexpr IssueError BasicDescriptorBlockSizeTooSmall{
        6010, "Basic DFD block descriptorBlockSize is too small.",
        "DFD block #{} descriptorBlockSize is {} which is smaller than the minimum size of a basic "
        "DFD block (24 bytes)."};
    static constexpr IssueError BasicVersionNotSupported{
        6011, "Unsupported basic DFD block version.",
        "DFD block #{} versionNumber in basic DFD block is {} but it must be "
        "KHR_DF_VERSIONNUMBER_1_3."};
    static constexpr IssueError BasicInvalidTransferFunction{
        6012,
        "Invalid transferFunction in basic DFD block. It must be either KHR_DF_TRANSFER_LINEAR or "
        "KHR_DF_TRANSFER_SRGB.",
        "DFD block #{} transferFunction in basic DFD block is {} but it must be either "
        "KHR_DF_TRANSFER_LINEAR or KHR_DF_TRANSFER_SRGB."};
    static constexpr IssueError BasicSRGBMismatch{
        6013,
        "Invalid transferFunction in basic DFD block. For an sRGB VkFormat it must be "
        "KHR_DF_TRANSFER_SRGB.",
        "DFD block #{} transferFunction in basic DFD block is {} but for VkFormat {} it must be "
        "KHR_DF_TRANSFER_SRGB."};
    static constexpr IssueError BasicNotSRGBMismatch{
        6014,
        "Invalid transferFunction in basic DFD block. For a non-sRGB VkFormat with sRGB variants "
        "it must not be KHR_DF_TRANSFER_SRGB.",
        "DFD block #{} transferFunction is KHR_DF_TRANSFER_SRGB but for VkFormat {} it must not be "
        "KHR_DF_TRANSFER_SRGB."};
    ...
    static constexpr IssueError IncorrectModelForBLZE{
        ...
        "DFD block #{} colorModel in basic DFD block is {} but for BasisLZ supercompression it "
        "must be KHR_DF_MODEL_ETC1S."};
    ...
    static constexpr IssueError InvalidTexelBlockDimension{
        ...
        "DFD block #{} texel block dimensions in basic DFD block are {}x{}x{}x{} but these must be "
        "{}x{}x{}x{} for {} textures."};
    static constexpr IssueError BytesPlanesMismatch{
        6021,
        "Invalid bytesPlanes in basic DFD block. The values do not match the expected values.",
        "DFD block #{} bytesPlanes in basic DFD block are {} {} {} {} {} {} {} {} but for {} "
        "textures these must be {} {} {} {} {} {} {} {}."};
    static constexpr IssueError BytesPlanesNotUnsized{
        6022,
        "Invalid bytesPlanes in basic DFD block. BytesPlanes must be 0 for supercompressed "
        "textures.",
        "DFD block #{} bytesPlanes in basic DFD block are {} {} {} {} {} {} {} {} but for {} "
        "supercompressed textures these must be zeros."};
    static constexpr IssueError BytesPlane0Zero{
        6023,
        "Invalid bytesPlane0 in basic DFD block. BytesPlane0 must be non-zero for "
        "non-supercompressed VK_FORMAT_UNDEFINED textures.",
        "DFD block #{} bytesPlane0 in basic DFD block is {} but it must be non-zero for "
        "non-supercompressed VK_FORMAT_UNDEFINED textures."};
    static constexpr IssueError MultiplaneFormatsNotSupported{
        ...
        "DFD block #{} bytesPlanes in basic DFD block are {} {} {} {} {} {} {} {} but "
        "bytesPlane[1-7] must be 0 as multiplane formats are not supported."};
    static constexpr IssueError SampleCountMismatch{
        6025,
        "Invalid sample count in basic DFD block. The sample count must match the expected sample "
        "count of the VkFormat.",
    ...
    static constexpr IssueError ZeroSamples{
        6027,
        "Invalid sample count in basic DFD block. The sample count must be non-zero for "
        "non-supercompressed textures with VK_FORMAT_UNDEFINED.",
        "DFD block #{} sample count in basic DFD block is 0 but non-supercompressed "
        "VK_FORMAT_UNDEFINED textures must have sample information."};
    static constexpr IssueError FormatMismatch{6028,
                                               "Invalid sample in basic DFD block. The samples "
                                               "must match the expected samples of the VkFormat.",
                                               "DFD block #{} sample #{} {} in basic DFD block is "
                                               "{} but the expected value is {} for {}."};
    static constexpr IssueWarning TooManySample{
        ...
        "DFD block #{} sample count in basic DFD block is {} which exceeds the validator limit of "
        "{}. Skipping validation of the last {} sample(s) ({} byte(s))."};
    ...
    static constexpr IssueError InvalidChannelForModel{
        ...
        "DFD block #{} sample #{} channelType in basic DFD block is {} which is not valid for "
        "colorModel {}."};
    static constexpr IssueError InvalidBitOffsetForUASTC{
        ...
        "DFD block #{} sample #{} bitOffset in basic DFD block is {} but for UASTC textures it "
        "must be 0."};
    static constexpr IssueError InvalidBitOffsetForBLZE{
        ...
        "DFD block #{} sample #{} bitOffset in basic DFD block is {} but for BasisLZ/ETC1S "
        "textures it must be {}."};
    static constexpr IssueError InvalidBitLengthForUASTC{
        ...
        "DFD block #{} sample #{} bitLength in basic DFD block is {} but for UASTC textures it "
        "must be 127."};
    static constexpr IssueError InvalidBitLengthForBLZE{
        ...
        "DFD block #{} sample #{} bitLength in basic DFD block is {} but for BasisLZ/ETC1S "
        "textures it must be 63."};
    ...
    static constexpr IssueError InterpretDFDMixedChannels{
        6203,
        "Mixed sample types. The Signed/Unsigned and Float/Integer flags of Basic DFD samples must "
        "be the consistent.",
        "DFD block #{} has mixed Signed/Unsigned or Float/Integer samples but they must be "
        "consistent."};
    static constexpr IssueError InterpretDFDMultisample{
        ...
        "DFD block #{} indicates multiple sample locations but multisample formats are not "
        "supported."};
    ...
    static constexpr IssueError IncorrectModelGLTFBU{
        ...
        "DFD block #{} colorModel in basic DFD block is {} but for KHR_texture_basisu "
        "compatibility it must be either ETC1S or UASTC."};
    static constexpr IssueError IncompatibleModelGLTFBU{
        6302,
        "Incompatible supercompressionScheme and colorModel for KHR_texture_basisu compatibility.",
        "DFD block #{} colorModel is {} while supercompressionScheme is {} but KHR_texture_basisu "
        "requires supercompressionScheme {} for this colorModel."};
    static constexpr IssueError InvalidChannelGLTFBU{
        ...
        "DFD block #{} colorModel is {} but sample #{} channelType is {} while KHR_texture_basisu "
        "requires {}."};
    static constexpr IssueError InvalidColorSpaceGLTFBU{
        6304, "Color space information is incompatible with KHR_texture_basisu.",
        "DFD block #{} primaries is {} and transfer is {} but KHR_texture_basisu requires either "
        "KHR_DF_PRIMARIES_BT709 with KHR_DF_TRANSFER_SRGB or KHR_DF_PRIMARIES_UNSPECIFIED with "
...
struct Metadata {
    ...
    static constexpr IssueWarning TooManyEntries{
        7001,
        "Too many Key/Value entries. The number of key-value entries exceeds the validator limit.",
        "The number of key-value entries exceeds the validator limit of {}. Skipping validation of "
        "the remaining {} byte(s)."};
    static constexpr IssueError NotEnoughDataForAnEntry{
        7002,
        "Invalid Key/Value Data. Not enough data left in Key/Value Data to process another "
        "key-value entry",
        "Key/Value Data has {} byte(s) unprocessed but for a key value entry at least 6 bytes are "
        "required (4 byte size + 1 byte key + null terminator)."};
    static constexpr IssueError KeyAndValueByteLengthTooLarge{
        7003,
        "Invalid keyAndValueByteLength. keyAndValueByteLength is greater than the amount of bytes "
        "left in the Key/Value Data.",
        "keyAndValueByteLength is {} but the Key/Value Data only has {} byte(s) left for the "
        "key-value pair."};
    ...
    static constexpr IssueError KeyMissingNullTerminator{
        ...
        "The key-value entry \"{}\" is missing the NULL terminator but every key-value entry must "
        "have a NULL terminator separating the key from the value."};
    ...
    static constexpr IssueError SizesDontAddUp{
        7008,
        "kvdByteLength must add up to the sum of the size of the key-value entries with paddings.",
        "The processed Key/Value Data length is {} byte(s) but kvdByteLength is {} byte(s) and "
        "they must match."};
    static constexpr IssueError UnknownReservedKey{
        ...
        "The key is \"{}\" but its not recognized and keys with \"KTX\" or \"ktx\" prefix are "
        "reserved."};
    static constexpr IssueWarning CustomMetadata{7010, "Custom key in Key/Value Data.",
    ...
    static constexpr IssueError OutOfOrder{
        7012,
        "Invalid Key/Value Data. Key-value entries must be sorted by key.",
        "Key-value entries are not sorted but they must be sorted by key.",
    };
    static constexpr IssueError DuplicateKey{7013, "Invalid Key/Value Data. Keys must be unique.",
                                             "Duplicate key-value entry with key \"{}\"."};
    static constexpr IssueError KeyEmpty{7013, "Empty key in Key/Value Data.",
    ...
    static constexpr IssueError KTXcubemapIncompleteIncompatibleLayerCount{
        7104,
        "Incompatible KTXcubemapIncomplete and layerCount. layerCount must be the multiple of the "
        "number of faces present.",
        "layerCount is {} and KTXcubemapIncomplete indicates {} faces present but layerCount must "
        "the multiple of the number of faces present."};
    ...
    static constexpr IssueError KTXorientationIncorrectDimension{
        7108,
        "Invalid KTXorientation value. The number of dimensions specified must match the number of "
        "dimensions in the texture type.",
    ...
    static constexpr IssueError KTXorientationInvalidValue{
        7109,
        "Invalid KTXorientation value. The value must match /^[rl]$/ for 1D, /^[rl][du]$/ for 2D "
        "and /^[rl][du][oi]$/ for 3D texture types.",
    ...
    static constexpr IssueError KTXglFormatWithVkFormat{
        7111,
        "Incompatible KTXglFormat and VkFormat. If KTXglFormat is present vkFormat must be "
        "VK_FORMAT_UNDEFINED.",
    ...
    static constexpr IssueError KTXglFormatInvalidValueForCompressed{
        7112,
        "Invalid KTXglFormatInvalidValue value. glFormat and glType must be zero for compressed "
        "formats.",
    ...
    static constexpr IssueError KTXdxgiFormatWithVkFormat{
        7114,
        "Incompatible KTXdxgiFormat__ and VkFormat. If KTXdxgiFormat__ is present vkFormat must be "
        "VK_FORMAT_UNDEFINED.",
    ...
    static constexpr IssueError KTXmetalPixelFormatWithVkFormat{
        7116,
        "Incompatible KTXmetalPixelFormat and VkFormat. If KTXmetalPixelFormat is present vkFormat "
    ...
    static constexpr IssueError KTXswizzleInvalidSize{
        7118,
        "Invalid KTXswizzle value. The size of the value must be 5 bytes (including the NULL "
        "terminator).",
        "The size of KTXswizzle value is {} byte(s) but it must be 5 bytes (including the NULL "
        "terminator)."};
    ...
    static constexpr IssueError KTXwriterRequiredButMissing{
        7124,
        "Missing KTXwriter metadata. When KTXwriterScParams is present KTXwriter must also be "
        "present.",
        "KTXwriter metadata is missing. When KTXwriterScParams is present KTXwriter must also be "
        "present."};
    static constexpr IssueWarning KTXwriterMissing{
        ...
        "KTXwriter metadata is missing. Writers are strongly urged to identify themselves via "
        "this."};
    ...
    static constexpr IssueError KTXanimDataWithCubeIncomplete{
        7130,
        "Incompatible KTXanimData and KTXcubemapIncomplete metadata. KTXanimData and "
        "KTXcubemapIncomplete cannot be present at the same time.",
    ...
    static constexpr IssueWarning KTXastcDecodeModeNotASTC{
        7134,
        "KTXastcDecodeMode has no effect on and should not be present in KTX files that use a "
        "non-ASTC formats.",
        "KTXastcDecodeMode is present but for colorModel {} it has no effect."};
    static constexpr IssueWarning KTXastcDecodeModeWithsRGB{
        7135,
        "KTXastcDecodeMode has no effect on and should not be present in KTX files that use the "
    ...
    static constexpr IssueError KTXswizzleInvalidGLTFBU{
        ...
        "KTXswizzle is \"{}\" but must be \"rgba\", if present, for KHR_texture_basisu "
        "compatibility."};
    static constexpr IssueError KTXorientationInvalidGLTFBU{
        ...
        "KTXorientation is \"{}\" but must be \"rd\", if present, for KHR_texture_basis "
        "compatibility."};
};
...
struct SGD {
    ...
    static constexpr IssueError BLZESizeTooSmallHeader{
        8101,
        "Invalid sgdByteLength for BasisLZ/ETC1S. sgdByteLength must be at least 20 bytes (sizeof "
        "ktxBasisLzGlobalHeader).",
        "sgdByteLength is {} but for BasisLZ/ETC1S textures it must be at least 20 bytes (sizeof "
        "ktxBasisLzGlobalHeader)."};
    static constexpr IssueError BLZESizeIncorrect{
        8102,
        "Invalid sgdByteLength for BasisLZ/ETC1S. sgdByteLength must be consistent with image "
        "count and BasisLzGlobalHeader.",
        "sgdByteLength is {} but based on image count of {} and the BasisLzGlobalHeader the "
        "expected value is {} (20 + 20 * imageCount + endpointsByteLength + selectorsByteLength + "
        "tablesByteLength + extendedByteLength)."};
    static constexpr IssueError BLZEExtendedByteLengthNotZero{
        8103,
        "Invalid extendedByteLength in BasisLzGlobalHeader. For BasisLZ/ETC1S the "
        "extendedByteLength must be 0.",
    ...
    static constexpr IssueError BLZEInvalidImageFlagBit{
        ...
        "For Level {} Layer {} Face {} zSlice {} the imageFlags is 0x{:08X} which has an invalid "
        "bit set."};
    static constexpr IssueError BLZENoAnimationSequencesPFrame{
        8105,
        "Incompatible PFrame with missing KTXanimData. Only animation sequences can have PFrames.",
        "There is a PFrame in a BasisLzEtc1sImageDesc but the KTXanimData is missing."};
    static constexpr IssueError BLZEZeroRGBLength{
        8106,
        "Invalid rgbSliceByteLength in BasisLzEtc1sImageDesc. rgbSliceByteLength must not be 0.",
        "For Level {} Layer {} Face {} zSlice {} the rgbSliceByteLength is {} but it must not be "
        "0."};
    static constexpr IssueError BLZEInvalidRGBSlice{
        8107,
        "Invalid rgbSliceByteOffset or rgbSliceByteLength. The defined byte region must be within "
        "the corresponding mip level.",
        "For Level {} Layer {} Face {} zSlice {} the rgbSliceByteOffset is {} and the "
        "rgbSliceByteLength is {} but the defined region must fit in the level's byteLength of "
        "{}."};
    static constexpr IssueError BLZEInvalidAlphaSlice{
        8108,
        "Invalid alphaSliceByteOffset or alphaSliceByteLength. The defined byte region must be "
        "within the corresponding mip level.",
        "For Level {} Layer {} Face {} zSlice {} the alphaSliceByteOffset is {} and the "
        "alphaSliceByteLength is {} but the defined region must fit in the level's byteLength of "
        "{}."};
    static constexpr IssueError BLZEDFDMismatchAlpha{
        8109,
        "Incompatible alphaSliceByteLength and DFD sampleCount. If DFD indicates an alpha slice "
        "the alphaSliceByteLength in BasisLzEtc1sImageDesc must not be 0.",
        "For Level {} Layer {} Face {} zSlice {} the alphaSliceByteLength is 0 but DFD indicates "
        "an alpha slice so it must not be 0."};
    static constexpr IssueError BLZEDFDMismatchNoAlpha{
        8110,
        "Incompatible alphaSliceByteLength and DFD sampleCount. If DFD indicates no alpha slice "
        "the alphaSliceByteLength in BasisLzEtc1sImageDesc must be 0.",
        "For Level {} Layer {} Face {} zSlice {} the alphaSliceByteLength is {} but DFD indicates "
        "no alpha slice so it must be 0."};
};

struct System {
    // 90xx - Generic System issues
    static constexpr IssueError OutOfMemory{9001,
                                            "System ran out of memory during a validation step.",
