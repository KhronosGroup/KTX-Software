...
struct IOError {
    static constexpr IssueFatal FileOpen{1001, "Failed to open file.", "Failed to open file {}: {}."};
    static constexpr IssueFatal FileReadFailure{
        1002, "Failed to read from file.", "Requested {} bytes but only read {} byte(s) at offset {} to access {}. File error {}."};
    ...
    static constexpr IssueFatal FileSeekFailure{1007, "Failed to seek in the file.",
...
struct HeaderData {
    ...
    static constexpr IssueError ProhibitedFormat{3001, "Prohibited VkFormat.", "VkFormat {} is prohibited in a KTX2 file."};
    static constexpr IssueError InvalidFormat{3002, "Invalid VkFormat.", "Invalid VkFormat {}."};
    static constexpr IssueWarning UnknownFormat{3003, "Unknown VkFormat. Possibly an extension format.",
    ...
    static constexpr IssueError TypeSizeMismatch{3012,
                                                 "Invalid typeSize. The value must match the expected typeSize of the VkFormat.",
                                                 "typeSize is {} but for VkFormat {} it must be {}."};
    static constexpr IssueError CubeWithDepth{3013, "Invalid pixelDepth. pixelDepth must be 0 for cube maps.",
                                              "pixelDepth is {} but for cube maps it must be 0 (cube map faces must be 2D)."};
    static constexpr IssueWarning ThreeDArray{3014, "File contains a 3D array texture.",
    ...
    static constexpr IssueError TooManyMipLevels{
        3016, "Too many mip levels.", "levelCount is {} but for the largest image dimension which is {} it is too many level."};
    static constexpr IssueError BlockCompressedNoLevel{3017,
    ...
    static constexpr IssueError IndexDFDInvalidOffset{3021, "Invalid dfdByteOffset.",
                                                      "dfdByteOffset is {} but the Data Format Descriptor must immediately follow "
                                                      "(with 4 byte alignment) the Level Index so it must be {}."};
    static constexpr IssueError IndexKVDInvalidOffset{3022, "Invalid kvdByteOffset.",
                                                      "kvdByteOffset is {} but the Key/Value Data must immediately follow (with 4 "
                                                      "byte alignment) the Data Format Descriptor so it must be {}."};
    static constexpr IssueError IndexKVDOffsetWithoutLength{3023, "kvdByteOffset must be 0 when kvdByteLength is 0.",
                                                            "kvdByteOffset is {} but must be 0 when kvdByteLength is 0."};
    static constexpr IssueError IndexSGDInvalidOffset{3024, "Invalid sgdByteOffset.",
                                                      "sgdByteOffset is {} but the Supercompression Global Data must immediately "
                                                      "follow (with 8 byte alignment) the preceding block so it must be {}."};
    static constexpr IssueError IndexSGDOffsetWithoutLength{3025, "sgdByteOffset must be 0 when sgdByteLength is 0.",
    ...
    static constexpr IssueError IndexDFDInvalidLength{
        3028,
        "Invalid dfdByteLength. If there is Key/Value Data the dfdByteLength/dfdTotalSize must be equal to kvdByteOffset - "
        "dfdByteOffset.",
    ...
    static constexpr IssueError InvalidSupercompressionGLTFBU{
        ...
        "supercompressionScheme is {} but it must either be BASIS_LZ for ETC1S or either NONE or ZSTD for UASTC textures for "
...
struct LevelIndex {
    ...
    static constexpr IssueError IncorrectByteOffsetUnaligned{4003,
                                                             "Invalid byteOffset in Level Index. byteOffset has to be aligned to "
                                                             "lcm(texel_block_size, 4) and must match expected value.",
                                                             "Level {} byteOffset is {} but based on the vkFormat, DFD and image "
                                                             "sizes the required alignment is {} and the expected value is {}."};
    ...
    static constexpr IssueError IncorrectUncompressedByteLength{
        4006,
        "Invalid uncompressedByteLength in Level Index. For non-supercompressed files the uncompressedByteLength must match the "
        "expected value of byteLength.",
    ...
    static constexpr IssueError UncompressedByteLengthMismatch{
        ...
        "Decompressing supercompression {} resulted in a different number of bytes than expected according to "
        "uncompressedByteLength."};
    static constexpr IssueError ZeroUncompressedLength{4009,
                                                       ...
                                                       "Level {} uncompressedByteLength is 0 but for non-BasisLZ files with "
                                                       "VK_FORMAT_UNDEFINED uncompressedByteLength must not be 0."};
    static constexpr IssueError InvalidUncompressedLength{
        4010,
        "Invalid uncompressedByteLength in Level Index. uncompressedByteLength must be equally divisible between every face and "
        "layer.",
...
struct Validator {
    ...
    static constexpr IssueError CreateExpectedDFDFailure{5001, "Failed to create expected DFD for the given VkFormat.",
                                                         "Failed to create expected DFD for the given VkFormat {}."};
    static constexpr IssueError CreateDFDRoundtripFailed{5002, "Failed to re-interpret expected DFD.",
                                                         "DFD created for VkFormat {} confused interpretDFD()."};
    static constexpr IssueWarning UnsupportedFeature{5003, "Feature not supported by libktx.",
    ...
    static constexpr IssueFatal CreateFailure{5005, "Failed to load texture using libktx.",
                                              "KTX 2.0 file is valid but libktx loading returned error: {}"};
    static constexpr IssueError DecompressChecksumError{5006, "Checksum error during decompression.",
                                                        "Decompressing supercompression {} resulted in a checksum error."};
    static constexpr IssueError TranscodeFailure{5007, "Failed to transcode texture.",
...
struct DFD {
    ...
    static constexpr IssueError SizeMismatch{6001,
                                             "Mismatching dfdTotalSize and dfdByteLength. dfdTotalSize must match dfdByteLength.",
    ...
    static constexpr IssueWarning UnknownDFDBlock{
        6003, "Unrecognized DFD block.", "DFD block #{} vendorId {} and descriptorType {} is not recognized and thus ignored."};
    ...
    static constexpr IssueError BasicDescriptorBlockSizeInvalid{
        ...
        "DFD block #{} descriptorBlockSize is {} which does not fit the criteria (descriptorBlockSize - 24) % 16 == 0 for basic "
        "DFD blocks."};
    ...
    static constexpr IssueError BasicInvalidTransferFunction{
        ...
        "DFD block #{} transferFunction in basic DFD block is {} but it must be either KHR_DF_TRANSFER_LINEAR or "
    ...
    static constexpr IssueError BasicNotSRGBMismatch{
        6014,
        "Invalid transferFunction in basic DFD block. For a non-sRGB VkFormat with sRGB variants it must not be "
        "KHR_DF_TRANSFER_SRGB.",
    ...
    static constexpr IssueError InvalidColorPrimaries{6019, "Invalid colorPrimaries in basic DFD block.",
    ...
    static constexpr IssueError BytesPlanesNotUnsized{
        ...
        "DFD block #{} bytesPlanes in basic DFD block are {} {} {} {} {} {} {} {} but for {} supercompressed textures these must "
        "be zeros."};
    static constexpr IssueError BytesPlane0Zero{6023,
    ...
    static constexpr IssueError MultiplaneFormatsNotSupported{
        ...
        "DFD block #{} bytesPlanes in basic DFD block are {} {} {} {} {} {} {} {} but bytesPlane[1-7] must be 0 as multiplane "
    ...
    static constexpr IssueError ZeroSamples{6027,
    ...
    static constexpr IssueWarning TooManySample{6029,
                                                "Too many BDFD sample. The number of BDFD samples exceeds the validator limit.",
                                                "DFD block #{} sample count in basic DFD block is {} which exceeds the validator "
                                                "limit of {}. Skipping validation of the last {} sample(s) ({} byte(s))."};
    ...
    static constexpr IssueError IncorrectModelGLTFBU{6301,
                                                     "Invalid colorModel in basic DFD block for KHR_texture_basisu compatibility.",
    ...
    static constexpr IssueError IncompatibleModelGLTFBU{
        ...
        "DFD block #{} colorModel is {} while supercompressionScheme is {} but KHR_texture_basisu requires supercompressionScheme "
        "{} for this colorModel."};
    ...
    static constexpr IssueError InvalidColorSpaceGLTFBU{
        ...
        "DFD block #{} primaries is {} and transfer is {} but KHR_texture_basisu requires either KHR_DF_PRIMARIES_BT709 with "
        "KHR_DF_TRANSFER_SRGB or KHR_DF_PRIMARIES_UNSPECIFIED with KHR_DF_TRANSFER_LINEAR."};
};
...
struct Metadata {
    ...
    static constexpr IssueError NotEnoughDataForAnEntry{
        ...
        "Key/Value Data has {} byte(s) unprocessed but for a key value entry at least 6 bytes are required (4 byte size + 1 byte "
        "key + null terminator)."};
    static constexpr IssueError KeyAndValueByteLengthTooLarge{
        7003,
        "Invalid keyAndValueByteLength. keyAndValueByteLength is greater than the amount of bytes left in the Key/Value Data.",
    ...
    static constexpr IssueError KeyMissingNullTerminator{
        ...
        "The key-value entry \"{}\" is missing the NULL terminator but every key-value entry must have a NULL terminator "
        "separating the key from the value."};
    static constexpr IssueError KeyForbiddenBOM{7006, "Invalid key in Key/Value Data. Key must not contain BOM.",
                                                "The beginning of the key \"{}\" has forbidden BOM."};
    static constexpr IssueError KeyInvalidUTF8{7007, "Invalid key in Key/Value Data. Key must be a valid UTF-8 string.",
    ...
    static constexpr IssueError PaddingNotZero{7011, "Invalid padding byte value. Every padding byte's value must be 0.",
    ...
    static constexpr IssueError KeyEmpty{7013, "Empty key in Key/Value Data.", "Key length is 0 byte in key-value entry."};

    static constexpr IssueError KTXcubemapIncompleteInvalidBitSet{7101,
    ...
    static constexpr IssueError KTXcubemapIncompleteNoBitSet{7103, "Invalid KTXcubemapIncomplete value. No face is marked present.",
    ...
    static constexpr IssueError KTXcubemapIncompleteIncompatibleLayerCount{
        ...
        "layerCount is {} and KTXcubemapIncomplete indicates {} faces present but layerCount must the multiple of the number of "
        "faces present."};
    ...
    static constexpr IssueError KTXorientationIncorrectDimension{
        7108,
        "Invalid KTXorientation value. The number of dimensions specified must match the number of dimensions in the texture type.",
        "The value has {} dimension but the texture type has {} and they must match."};
    static constexpr IssueError KTXorientationInvalidValue{7109,
                                                           "Invalid KTXorientation value. The value must match /^[rl]$/ for 1D, "
                                                           "/^[rl][du]$/ for 2D and /^[rl][du][oi]$/ for 3D texture types.",
                                                           "Dimension {} is \"{}\" but it must be either \"{}\" or \"{}\"."};

    // 71xx - Known Key-Value related issues:

    static constexpr IssueError KTXglFormatInvalidSize{7110,
                                                       "Invalid KTXglFormat metadata. The size of the value must be 12 bytes.",
    ...
    static constexpr IssueError KTXdxgiFormatInvalidSize{7113,
    ...
    static constexpr IssueError KTXmetalPixelFormatWithVkFormat{
        7116,
        "Incompatible KTXmetalPixelFormat and VkFormat. If KTXmetalPixelFormat is present vkFormat must be VK_FORMAT_UNDEFINED.",
        "vkFormat is {} but it must be VK_FORMAT_UNDEFINED if KTXmetalPixelFormat is present."};

    static constexpr IssueError KTXswizzleMissingNull{7117, "Invalid KTXswizzle value. The value is missing the NULL terminator.",
                                                      "The last byte of the value must be a NULL terminator."};
    ...
    static constexpr IssueError KTXswizzleInvalidValue{7119, "Invalid KTXswizzle value. The value must match /^[rgba01]{4}$/.",
                                                       "The character at index {} is \"{}\" but it must be one of \"rgba01\"."};
    // Unused 7120
    static constexpr IssueWarning KTXswizzleWithDepthOrStencil{7121,
                                                               "KTXswizzle has no effect on depth or stencil texture formats.",
                                                               "KTXswizzle is present but for VkFormat {} it has no effect."};

    static constexpr IssueError KTXwriterMissingNull{7122, "Invalid KTXwriter metadata. The value is missing the NULL terminator.",
                                                     "The last byte of the value must be a NULL terminator."};
    static constexpr IssueError KTXwriterInvalidUTF8{7123, "Invalid KTXwriter value. The value must be a valid UTF8 string.",
    ...
    static constexpr IssueError KTXanimDataInvalidSize{7128,
                                                       "Invalid KTXanimData metadata. The size of the value must be 12 bytes.",
    ...
    static constexpr IssueError KTXanimDataWithCubeIncomplete{
        7130,
        "Incompatible KTXanimData and KTXcubemapIncomplete metadata. KTXanimData and KTXcubemapIncomplete cannot be present at the "
        "same time.",
...
struct SGD {
    ...
    static constexpr IssueError BLZESizeIncorrect{
        ...
        "sgdByteLength is {} but based on image count of {} and the BasisLzGlobalHeader the expected value is {} (20 + 20 * "
        "imageCount + endpointsByteLength + selectorsByteLength + tablesByteLength + extendedByteLength)."};
    ...
    static constexpr IssueError BLZEInvalidRGBSlice{
        8107,
        "Invalid rgbSliceByteOffset or rgbSliceByteLength. The defined byte region must be within the corresponding mip level.",
        "For Level {} Layer {} Face {} zSlice {} the rgbSliceByteOffset is {} and the rgbSliceByteLength is {} but the defined "
        "region must fit in the level's byteLength of {}."};
    static constexpr IssueError BLZEInvalidAlphaSlice{
        8108,
        "Invalid alphaSliceByteOffset or alphaSliceByteLength. The defined byte region must be within the corresponding mip level.",
        "For Level {} Layer {} Face {} zSlice {} the alphaSliceByteOffset is {} and the alphaSliceByteLength is {} but the defined "
        "region must fit in the level's byteLength of {}."};
    static constexpr IssueError BLZEDFDMismatchAlpha{8109,
                                                     "Incompatible alphaSliceByteLength and DFD sampleCount. If DFD indicates an "
                                                     "alpha slice the alphaSliceByteLength in BasisLzEtc1sImageDesc must not be 0.",
                                                     "For Level {} Layer {} Face {} zSlice {} the alphaSliceByteLength is 0 but "
                                                     "DFD indicates an alpha slice so it must not be 0."};
    static constexpr IssueError BLZEDFDMismatchNoAlpha{
        8110,
        "Incompatible alphaSliceByteLength and DFD sampleCount. If DFD indicates no alpha slice the alphaSliceByteLength in "
        "BasisLzEtc1sImageDesc must be 0.",
...
struct System {
    ...
    static constexpr IssueError OutOfMemory{9001, "System ran out of memory during a validation step.",
