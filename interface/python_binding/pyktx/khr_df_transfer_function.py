...
class KhrDfTransferFunction(IntEnum):
    ...
    TRANSFER_DCIP3       = 12
    TRANSFER_DCIP3_EOTF  = 12
    """DCI P3 transfer function."""

    TRANSFER_PAL_OETF    = 13
    """Legacy PAL OETF."""

    TRANSFER_PAL625_EOTF = 14
    """Legacy PAL 625-line EOTF."""

    TRANSFER_ST240       = 15
    TRANSFER_ST240_OETF  = 15
    TRANSFER_ST240_EOTF  = 15
    """Legacy ST240 transfer function."""

    TRANSFER_ACESCC      = 16
    TRANSFER_ACESCC_OETF = 16
    """ACEScc transfer function."""

    TRANSFER_ACESCCT      = 17
    TRANSFER_ACESCCT_OETF = 17
    """ACEScct transfer function."""

    TRANSFER_ADOBERGB      = 18
    TRANSFER_ADOBERGB_EOTF = 18
    """Adobe RGB (1998) transfer function."""

    TRANSFER_HLG_UNNORMALIZED_OETF = 19
