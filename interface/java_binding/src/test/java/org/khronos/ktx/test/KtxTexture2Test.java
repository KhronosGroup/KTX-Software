...
public class KtxTexture2Test {
    ...
    public void testCreateFromMemoryBasic() {
        ...
        int createFlags = KtxTextureCreateFlagBits.KTX_TEXTURE_CREATE_LOAD_IMAGE_DATA_BIT;
    ...
    public void testCreateFromNamedFileWithNull() {
        ...
        assertThrows(NullPointerException.class,
                () -> KtxTexture2.createFromNamedFile(null, KtxTextureCreateFlagBits.KTX_TEXTURE_CREATE_NO_FLAGS),
                "Expected to throw NullPointerException");
    }
    ...
    public void testCompressBasis() {
        ...
        assertEquals(KtxErrorCode.KTX_SUCCESS, texture.compressBasis(1));
    ...
    public void testCompressBasisEx() {
        ...
        assertEquals(KtxErrorCode.KTX_SUCCESS, texture.compressBasisEx(new KtxBasisParams()));
