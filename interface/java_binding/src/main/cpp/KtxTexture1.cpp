...
Java_org_khronos_ktx_KtxTexture1_getGlInternalformat(JNIEnv *env, jobject thiz) {
    return get_ktx1_texture(env, thiz)->glInternalformat;
}

extern "C" JNIEXPORT jint JNICALL
Java_org_khronos_ktx_KtxTexture1_getGlBaseInternalformat(JNIEnv *env, jobject thiz) {
    return get_ktx1_texture(env, thiz)->glBaseInternalformat;
}

extern "C" JNIEXPORT jobject JNICALL Java_org_khronos_ktx_KtxTexture1_create(
    JNIEnv *env, jobject, jobject java_create_info, jint storageAllocation) {
    ...
    ktxTextureCreateStorageEnum storage_alloc =
        static_cast<ktxTextureCreateStorageEnum>(storageAllocation);
...
extern "C" JNIEXPORT jobject JNICALL Java_org_khronos_ktx_KtxTexture1_createFromNamedFile(
