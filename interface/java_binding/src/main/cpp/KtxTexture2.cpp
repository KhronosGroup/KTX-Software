...
extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_compressAstcEx(JNIEnv *env, jobject thiz, jobject jparams) {
...
extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_compressAstc(JNIEnv *env, jobject thiz, jint quality) {
    return ktxTexture2_CompressAstc(get_ktx2_texture(env, thiz), static_cast<uint32_t>(quality));
}

extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_compressBasisEx(JNIEnv *env, jobject thiz, jobject jparams) {
...
extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_compressBasis(JNIEnv *env, jobject thiz, jint quality) {
    return ktxTexture2_CompressBasis(get_ktx2_texture(env, thiz), static_cast<uint32_t>(quality));
}

extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_transcodeBasis(JNIEnv *env, jobject thiz, jint outputFormat,
                                                                                  jint transcodeFlags) {
    return ktxTexture2_TranscodeBasis(get_ktx2_texture(env, thiz), static_cast<ktx_transcode_fmt_e>(outputFormat), transcodeFlags);
}

extern "C" JNIEXPORT jobject JNICALL Java_org_khronos_ktx_KtxTexture2_create(JNIEnv *env, jobject,
...
extern "C" JNIEXPORT jobject JNICALL Java_org_khronos_ktx_KtxTexture2_createFromNamedFile(JNIEnv *env, jobject, jstring filename,
                                                                                          jint createFlags) {
