...
extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_getOETF(JNIEnv *env,
                                                                           jobject thiz) {
    return ktxTexture2_GetOETF(get_ktx2_texture(env, thiz));
}

extern "C" JNIEXPORT jboolean JNICALL
Java_org_khronos_ktx_KtxTexture2_getPremultipliedAlpha(JNIEnv *env, jobject thiz) {
    return ktxTexture2_GetPremultipliedAlpha(get_ktx2_texture(env, thiz));
}

extern "C" JNIEXPORT jboolean JNICALL
Java_org_khronos_ktx_KtxTexture2_needsTranscoding(JNIEnv *env, jobject thiz) {
    return ktxTexture2_NeedsTranscoding(get_ktx2_texture(env, thiz));
}

extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_getVkFormat(JNIEnv *env,
                                                                               jobject thiz) {
    return get_ktx2_texture(env, thiz)->vkFormat;
}

extern "C" JNIEXPORT jint JNICALL
Java_org_khronos_ktx_KtxTexture2_getSupercompressionScheme(JNIEnv *env, jobject thiz) {
...
extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_compressAstcEx(JNIEnv *env,
    ...
    return ktxTexture2_CompressAstcEx(get_ktx2_texture(env, thiz), &params);
}

extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_compressAstc(JNIEnv *env,
                                                                                jobject thiz,
                                                                                jint quality) {
    return ktxTexture2_CompressAstc(get_ktx2_texture(env, thiz), static_cast<uint32_t>(quality));
}

extern "C" JNIEXPORT jint JNICALL
Java_org_khronos_ktx_KtxTexture2_compressBasisEx(JNIEnv *env, jobject thiz, jobject jparams) {
    ktxBasisParams params = {};
    copy_ktx_basis_params(env, jparams, params);

    return ktxTexture2_CompressBasisEx(get_ktx2_texture(env, thiz), &params);
}
...
extern "C" JNIEXPORT jint JNICALL Java_org_khronos_ktx_KtxTexture2_transcodeBasis(
    JNIEnv *env, jobject thiz, jint outputFormat, jint transcodeFlags) {
    return ktxTexture2_TranscodeBasis(get_ktx2_texture(env, thiz),
                                      static_cast<ktx_transcode_fmt_e>(outputFormat),
                                      transcodeFlags);
}

extern "C" JNIEXPORT jobject JNICALL
Java_org_khronos_ktx_KtxTexture2_create(JNIEnv *env, jobject,
    ...
    ktxTextureCreateStorageEnum storageAllocation =
        static_cast<ktxTextureCreateStorageEnum>(jStorageAllocation);
    ...
    jobject texture =
        env->NewObject(ktx_texture_class, ktx_texture_ctor, reinterpret_cast<jlong>(instance));

    return texture;
}

extern "C" JNIEXPORT jobject JNICALL Java_org_khronos_ktx_KtxTexture2_createFromNamedFile(
    JNIEnv *env, jobject, jstring filename, jint createFlags) {
